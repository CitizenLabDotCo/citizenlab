...
resource "Tags" do
  ...
  get 'web_api/v1/tags' do
    before do
      Tag.create(title_multiloc: { en: 'Fish' })
      Tag.create(title_multiloc: { en: 'Sea Lion' })
      Tag.create(title_multiloc: { en: 'Dolphin' })
      Tag.create(title_multiloc: { en: 'Shark' })
    end
    ...
    example 'Search for tags' do
      t1 = Tag.create(title_multiloc: { en: 'Avkdjsuz' })
