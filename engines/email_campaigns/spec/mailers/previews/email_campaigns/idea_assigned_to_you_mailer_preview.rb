    ...
    def campaign_mail
      ...
      command = {
        ...
        event_payload: {
          ...
          post_author_name: UserDisplayNameService.new(Tenant.current, recipient).display_name!(idea.author),
      ...
      campaign = EmailCampaigns::Campaigns::IdeaAssignedToYou.first
