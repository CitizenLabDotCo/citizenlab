module EmailCampaigns
  class UserWeeklyDigestJob < ApplicationJob
    ...
    def perform
      ...
      if ti_service.filter_trending(IdeaPolicy::Scope.new(nil, Idea).resolve).count < N_IDEAS
      ...
      User.all.each do |user|
        ...
        top_ideas = ti_service.sort_trending(ti_service.filter_trending(IdeaPolicy::Scope.new(user, Idea).resolve).left_outer_joins(:idea_status)).take N_IDEAS
