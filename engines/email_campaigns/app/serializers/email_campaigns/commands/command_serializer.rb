class EmailCampaigns::Commands::CommandSerializer < ActiveModel::Serializer

  class CommandUserSerializer < ActiveModel::Serializer
  ...
  class CommandProjectSerializer < ActiveModel::Serializer
  ...
  class CommandCommentSerializer < ActiveModel::Serializer
  ...
  class CommandIdeaSerializer < ActiveModel::Serializer
  ...
  class CommandImageSerializer < ActiveModel::Serializer
  ...
  belongs_to :recipient, serializer: CommandUserSerializer
