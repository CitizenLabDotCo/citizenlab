...
module.exports = {
  ...
  elements: {
    ...
    phasesTab: { selector: '.e2e-resource-tabs li:nth-child(3) a' },
    eventsTab: { selector: '.e2e-resource-tabs li:nth-child(4) a' },
    permissionsTab: { selector: '.e2e-resource-tabs li:nth-child(5) a' },
