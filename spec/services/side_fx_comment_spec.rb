...
describe SideFxCommentService do
  ...
  describe "after_create" do
    ...
    it "logs a 'mentioned' action for every expanded mention" do
      ...
      u1_mention_expanded = mention_service.add_span_around u1_mention, u1_mention, u1.id

      u2 = create(:user)
      u2_mention = mention_service.user_to_mention(u2)
      u2_mention_expanded = mention_service.add_span_around u2_mention, u2_mention, u2.id
