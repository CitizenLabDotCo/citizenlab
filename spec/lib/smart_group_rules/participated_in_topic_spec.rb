...
describe SmartGroupRules::ParticipatedInTopic do
  ...
  describe "description_multiloc" do
    ...
    let(:participated_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
      'predicate'     => 'in',
      'value'         => topic.id
    })}
    let(:participated_not_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
      'predicate'     => 'not_in',
      'value'         => topic.id
    })}
    let(:participated_posted_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
      'predicate'     => 'posted_in',
      'value'         => topic.id
    })}
    let(:participated_not_posted_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
      'predicate'     => 'not_posted_in',
      'value'         => topic.id
    })}
    let(:participated_commented_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
      'predicate'     => 'commented_in',
      'value'         => topic.id
    })}
    let(:participated_not_commented_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
      'predicate'     => 'not_commented_in',
      'value'         => topic.id
    })}
    let(:participated_voted_idea_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
      'predicate'     => 'voted_idea_in',
      'value'         => topic.id
    })}
    let(:participated_not_voted_idea_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
      'predicate'     => 'not_voted_idea_in',
      'value'         => topic.id
    })}
    let(:participated_voted_comment_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
      'predicate'     => 'voted_comment_in',
      'value'         => topic.id
    })}
    let(:participated_not_voted_comment_in_topic_in_rule) {SmartGroupRules::ParticipatedInTopic.from_json({
      'ruleType'      => 'participated_in_topic',
