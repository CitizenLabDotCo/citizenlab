...
resource "OfficialFeedback" do
  ...
  before do
    ...
    @feedbacks = create_list(:official_feedback, 2, vettable: @initiative)
  end
  ...
  context "when authenticated" do
    ...
    post "web_api/v1/initiatives/:initiative_id/official_feedback" do
      ...
      example_request "Create an official feedback on an initiative" do
        ...
        expect(json_response.dig(:data,:relationships,:vettable,:data,:id)).to eq initiative_id
    ...
    patch "web_api/v1/official_feedback/:id" do
      ...
      let(:official_feedback) { create(:official_feedback, user: @user, vettable: @initiative) }
