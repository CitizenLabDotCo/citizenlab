...
resource "Projects" do
  ...
  context 'when admin' do
    ...
    get "web_api/v1/projects" do
      ...
      parameter :publication_statuses, "Return only projects with the specified publication statuses (i.e. given an array of publication statuses); returns all published and archived projects by default", required: false
