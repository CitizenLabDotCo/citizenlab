const host = process.env.NODE_ENV === 'staging' ? 'https://pa11y.stg.citizenlab.co' : 'http://localhost:3000';
...
const config = {
  ...
  urls: process.env.NODE_ENV === 'staging' ? [
    ...
    `${host}/en-GB/projects`,
    `${host}/en-GB/projects/rup-inspraak-vanaf-startnota-tot-openbaar-onderzoek/events`,
    `${host}/en-GB/sign-in`,
    `${host}/en-GB/sign-up`,
    `${host}/en-GB/pages/information`
  ]
