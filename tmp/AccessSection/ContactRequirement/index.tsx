...
import { Channel, ContactRequirement, getOption } from "./constants";
...
const ContactRequirementControl = ({ value, available, onChange }: Props) => {
  ...
  return (
    <Box py="10px">
      ...
      <Trigger type="button" onClick={() => setModalOpen(true)}>
        <IconCluster option={option} size="large" active={value !== "none"} />
