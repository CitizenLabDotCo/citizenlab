...
describe('<Dropdown />', () => {
  ...
  it('defaults to z-index of 5', () => {
    const result = render(<Dropdown id="default-zindex" opened={true} content={<div>Test dropdown</div>} />);
  ...
  it('uses the value of the zIndex prop when supplied', () => {
    const result = render(<Dropdown id="prop-zindex" opened={true} content={<div>Test dropdown</div>} zIndex="100" />);
