...
// With 'either_email_or_phone' the requirement is satisfied by whichever of the
// two the user has, so the phone expiry only bites for a user without an email
