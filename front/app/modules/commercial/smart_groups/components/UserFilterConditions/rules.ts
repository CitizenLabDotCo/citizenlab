...
import InputTopicValueSelector from './ValueSelector/InputTopicValueSelector';
import InputTopicValuesSelector from './ValueSelector/InputTopicValuesSelector';
...
export const ruleTypeConstraints = {
  ...
  follow: {
    ...
    is_one_of_topics: GlobalTopicValuesSelector,
    is_not_topic: GlobalTopicValueSelector,
  ...
  participated_in_topic: {
    in: InputTopicValuesSelector,
    not_in: InputTopicValueSelector,
    posted_in: InputTopicValuesSelector,
    not_posted_in: InputTopicValueSelector,
    commented_in: InputTopicValuesSelector,
    not_commented_in: InputTopicValueSelector,
    reacted_idea_in: InputTopicValuesSelector,
    not_reacted_idea_in: InputTopicValueSelector,
    reacted_comment_in: InputTopicValuesSelector,
    not_reacted_comment_in: InputTopicValueSelector,
  },
  participated_in_idea_status: {
