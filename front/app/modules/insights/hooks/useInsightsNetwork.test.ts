...
import { insightsNetworkStream } from 'modules/insights/services/insightsNetwork';
...
jest.mock('modules/insights/services/insightsNetwork', () => {
  return {
...
jest.mock('modules/insights/services/insightsTextNetworkAnalysisTasks', () => {
  return {
