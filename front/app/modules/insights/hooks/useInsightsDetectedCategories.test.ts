...
import { insightsDetectedCategoriesStream } from 'modules/insights/services/insightsDetectCategories';
...
jest.mock('modules/insights/services/insightsDetectCategories', () => {
  return {
