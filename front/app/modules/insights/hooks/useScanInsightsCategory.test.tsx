...
import { insightsCategoriesSuggestionsTasksStream } from 'modules/insights/services/insightsCategoriesSuggestionsTasks';
...
jest.mock(
  'modules/insights/services/insightsCategoriesSuggestionsTasks',
  () => {
    return {
