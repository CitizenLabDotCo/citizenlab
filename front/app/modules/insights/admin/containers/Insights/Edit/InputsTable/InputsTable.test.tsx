...
import * as service from 'modules/insights/services/insightsInputs';
import useInsightsInputs from 'modules/insights/hooks/useInsightsInputs';
import * as batchService from 'modules/insights/services/batchAssignment';
import inputs from 'modules/insights/fixtures/inputs';
import categories from 'modules/insights/fixtures/categories';
import views from 'modules/insights/fixtures/views';

import clHistory from 'utils/cl-router/history';

jest.mock('modules/insights/services/insightsInputs', () => ({
  deleteInsightsInputCategory: jest.fn(),
  addInsightsInputCategories: jest.fn(),
}));

jest.mock('modules/insights/services/batchAssignment', () => ({
...
jest.mock('modules/insights/hooks/useInsightsCategory', () => {
  return jest.fn(() => mockCategoryData);
});

jest.mock('modules/insights/hooks/useInsightsCategories', () => {
  return jest.fn(() => mockCategoriesData);
});

jest.mock('modules/insights/hooks/useInsightsInputs', () => {
  return jest.fn(() => mockInputData);
});

jest.mock('modules/insights/hooks/useInsightsView', () => {
...
jest.mock('modules/insights/hooks/useInsightsInput', () => {
  return jest.fn(() => undefined);
});

const mockTriggerScan = jest.fn();

jest.mock('modules/insights/hooks/useScanInsightsCategory', () => {
  return jest.fn(() => ({
