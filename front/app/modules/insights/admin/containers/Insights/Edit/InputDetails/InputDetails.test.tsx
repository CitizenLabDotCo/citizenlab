...
import * as insightsService from 'modules/insights/services/insightsInputs';
import * as categoryService from 'modules/insights/services/insightsCategories';
...
jest.mock('modules/insights/services/insightsCategories', () => ({
