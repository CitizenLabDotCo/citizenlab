...
import * as service from 'modules/insights/services/insightsCategories';
...
jest.mock('modules/insights/hooks/useInsightsDetectedCategories', () => {
...
jest.mock('modules/insights/hooks/useInsightsInputsCount', () => {
