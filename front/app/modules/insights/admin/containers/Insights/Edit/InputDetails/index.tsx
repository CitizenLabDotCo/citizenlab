...
// services
import { addInsightsInputCategory } from 'modules/insights/services/insightsInputs';
import { addInsightsCategory } from 'modules/insights/services/insightsCategories';

// components
import Category from 'modules/insights/admin/components/Category';
import Idea from 'modules/insights/admin/components/Idea';
import { Label, Spinner, Icon, Box } from '@citizenlab/cl2-component-library';
import Creatable from 'react-select/creatable';
import selectStyles from 'components/UI/MultipleSelect/styles';
import Navigation, {
  NavigationProps,
} from 'modules/insights/admin/components/Navigation';

// hooks
import useInsightsCategories from 'modules/insights/hooks/useInsightsCategories';
import useInsightsInput from 'modules/insights/hooks/useInsightsInput';
...
import tracks from 'modules/insights/admin/containers/Insights/tracks';
