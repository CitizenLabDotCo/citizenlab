...
import useInsightsInputsLoadMore from 'modules/insights/hooks/useInsightsInputsLoadMore';
import inputs from 'modules/insights/fixtures/inputs';
import clHistory from 'utils/cl-router/history';
import mockCategories from 'modules/insights/fixtures/categories';
...
jest.mock('modules/insights/hooks/useInsightsInputsLoadMore', () => {
