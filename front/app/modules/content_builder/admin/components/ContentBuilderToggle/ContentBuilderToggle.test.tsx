import { addContentBuilderLayout } from 'modules/content_builder/services/contentBuilder';
...
jest.mock('modules/content_builder/hooks/useContentBuilder', () => {
  return jest.fn(() => mockContentBuilderLayoutData);
});
jest.mock('modules/content_builder/services/contentBuilder', () => ({
