...
const FullscreenPreview = React.lazy(
  () => import('modules/content_builder/admin/containers/FullscreenPreview')
);

const ContentViewer = React.lazy(
  () => import('modules/content_builder/admin/components/ContentViewer')
);

const ContentBuilderToggle = React.lazy(
  () => import('modules/content_builder/admin/components/ContentBuilderToggle')
);
