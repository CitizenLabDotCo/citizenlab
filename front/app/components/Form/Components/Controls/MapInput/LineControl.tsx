...
const LineControl = ({ ...props }: ControlProps) => {
...
export default withJsonFormsControlProps(LineControl);

export const lineControlTester = (uischema) => {
  if (uischema?.options?.input_type === 'line') {
    return 1000;
  }
  return -1;
};
