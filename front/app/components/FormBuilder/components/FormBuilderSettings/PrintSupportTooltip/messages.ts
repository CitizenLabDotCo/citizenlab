...
export default defineMessages({
  ...
  topic_ids: {
    id: 'app.components.formBuilder.printSupportTooltip.topics',
    defaultMessage:
      'Topics are shown as unsupported on the downloaded PDF and are not supported for import via FormSync.',
  },
  cosponsor_ids: {
    id: 'app.components.formBuilder.printSupportTooltip.cosponsor_ids',
    defaultMessage:
      'Cosponsor IDs are not shown on the downloaded PDF and are not supported for import via FormSync.',
  },
  fileupload: {
