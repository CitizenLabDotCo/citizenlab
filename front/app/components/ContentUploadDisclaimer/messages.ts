...
export default defineMessages({
  ...
  onAccept: {
    id: 'app.components.ContentUploadDisclaimer.onAccept',
    defaultMessage: 'I understand',
  },
  onCancel: {
    id: 'app.components.ContentUploadDisclaimer.onCancel',
