...
export const trendConfiguration: Record<
  ...
  { icon: IconNames | undefined; color: string }
> = {
  positive: { icon: 'trend-up', color: colors.green500 },
  negative: { icon: 'trend-down', color: colors.red400 },
  zero: { icon: undefined, color: colors.textSecondary },
};
