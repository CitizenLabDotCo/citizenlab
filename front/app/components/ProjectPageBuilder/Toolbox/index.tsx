...
// Toolbox for the project page builder. Initially the existing description
// widgets; the new project-page-only widgets (Timeline, Events, locked
// Title/Banner) are added here in later phases.
