...
export default defineMessages({
  currentAdminSeatsTitle: {
    id: 'app.components.SeatTrackerInfo.currentAdminSeatsTitle',
    defaultMessage: 'Current admin seats',
  },
  currentCollaboratorSeatsTitle: {
    id: 'app.components.SeatTrackerInfo.currentCollaboratorSeatsTitle',
    defaultMessage: 'Current collaborator seats',
  },
  includedSeats: {
    id: 'app.components.SeatTrackerInfo.includedSeats',
    defaultMessage: 'Included seats',
  },
  additionalSeats: {
    id: 'app.components.SeatTrackerInfo.additionalSeats',
    defaultMessage: 'Additional seats',
  },
  adminMessage: {
    id: 'app.components.SeatTrackerInfo.adminMessage',
    defaultMessage:
  ...
  adminSeatsIncludedSubText: {
    id: 'app.components.SeatTrackerInfo.adminSeatsIncludedSubText',
    defaultMessage: '{adminSeats} admin seats included',
  },
  collaboratorMessage: {
    id: 'app.components.SeatTrackerInfo.collaboratorMessage',
    defaultMessage:
