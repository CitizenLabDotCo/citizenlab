...
export default defineMessages({
  ...
  a11y_projectsHaveChanged: {
    id: 'app.containers.SearchInput.a11y_projectsHaveChanged',
    defaultMessage:
      '{numberOfFilteredResults, plural, zero {# results have loaded} one {# result has loaded} other {# results have loaded}}.',
  },
});
