...
const FormInputEditWarningModal = ({
  ...
  return (
    ...
    >
      <Box m="24px" data-cy="e2e-form-input-edit-warning-modal">
        <Box mb="32px" display="flex">
          <Text m="0px" fontSize="m" fontWeight="bold">
...
export default FormInputEditWarningModal;
