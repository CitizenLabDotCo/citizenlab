...
export default defineMessages({
  askDemographicQuestionsBefore: {
    id: 'app.components.admin.ActionForm.DataSection.DemographicSection.DemographicsPlacement.askDemographicQuestionsBefore',
    defaultMessage: 'Ask demographic questions before the user participates',
  },
  ...
  cannot_ask_demographic_fields_in_registration_flow_when_permitted_by_is_everyone:
    {
      id: 'app.components.admin.ActionForm.Fields.cannot_ask_demographic_fields_in_registration_flow_when_permitted_by_is_everyone3',
      defaultMessage:
        'When "Who can participate" is set to "Anyone", demographic questions can only be asked as the last page of the form.',
    },
