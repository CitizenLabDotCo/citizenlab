...
/*
  ...
  - Unlike ideas, proposals cannot be moved between phases, they can only belong to a single phase. And you can select that phase from the phase navigation on top. So there is no need.
