...
import { CLLocale, CLError, RHFErrors } from 'typings';
...
const QuillMultilocWithLocaleSwitcher = ({ name, ...rest }: Props) => {
  ...
  const defaultValue: Partial<Record<CLLocale, any>> = locales.reduce(
  ...
  const validationError = Object.values(
    (errors as Record<CLLocale, FieldError> | undefined) || {}
  )[0]?.message;
