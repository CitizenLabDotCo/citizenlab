export const addInitiative = jest.fn().mockImplementation(() => Promise.resolve({ data: { id: 'initiativeID' } }));
export const updateInitiative = jest.fn().mockImplementation(() => Promise.resolve());
...
export const makeInitiative = (id, enTitle) => (
  {
    ...
    relationships: {
      ...
      type:'users' } },
      initiative_status:{ data:{ id:'6a968b06-87ea-450a-887c-70b8e8dd4343',
