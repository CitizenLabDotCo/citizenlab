...
import type { SSOIconNames } from './ssoIcons';

// SSO provider brand icons are code-split into their own chunk and only loaded
// when an SSO icon is actually rendered. See `./ssoIcons.tsx`.
const SSOIcon = React.lazy(() => import('./ssoIcons'));

export type IconNames = keyof typeof icons | SSOIconNames;
...
export type IconPropsWithoutName = ariaHiddenProps &
  SvgProps & {
    className?: string;
    'data-testid'?: string;
  };
...
export const icons = {
  ...
  rheinbahn: (props: IconPropsWithoutName) => (
    <Svg
      ...
      height="24px"
      fill="none"
      aria-label="Rheinbahn logo"
      {...props}
    >
      <g id="svg_1">
        <path
          d="m15.51,9.35c-3.36,0 -6.08,2.73 -6.08,6.08c0,3.36 2.73,6.08 6.08,6.08s6.08,-2.73 6.08,-6.08c0,-3.36 -2.74,-6.08 -6.08,-6.08zm0,9.7c-2,0 -3.62,-1.62 -3.62,-3.62c0,-2 1.62,-3.62 3.62,-3.62s3.62,1.62 3.62,3.62c0,2 -1.62,3.62 -3.62,3.62z"
          fill="#e2001a"
        />
        <path
          d="m15.51,2.94c-6.89,0 -12.5,5.6 -12.5,12.5s5.6,12.5 12.5,12.5c6.63,0 12.1,-5.22 12.5,-11.77l4.87,0l0.42,-2.48l-7.95,0c0.1,0.57 0.15,1.16 0.15,1.75c0,5.48 -4.46,9.97 -9.97,9.97c-5.48,0 -9.97,-4.46 -9.97,-9.97s4.46,-9.97 9.97,-9.97c2.22,0 4.28,0.73 5.94,1.98l12.88,0l0.42,-2.48l-12.46,0c-1.96,-1.3 -4.29,-2.04 -6.82,-2.04z"
          fill="#e2001a"
        />
        <path
          d="m24.77,11.82l8.82,0l0.42,-2.48l-10.65,0c0.58,0.75 1.07,1.57 1.41,2.48z"
          fill="#e2001a"
        />
      </g>
    </Svg>
  ...
  cookie: (props: IconPropsWithoutName) => (
    <Svg
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 -960 960 960"
      {...props}
  ...
  spaces: (props: IconPropsWithoutName) => (
    <Svg
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 12 12"
      {...props}
    >
      <path d="M1.938 11.063A1.45 1.45 0 0 1 1.5 10q0-.625.438-1.062A1.45 1.45 0 0 1 3 8.5q.175 0 .325.037.15.038.287.1l.713-.887a2.2 2.2 0 0 1-.488-.875 2.3 2.3 0 0 1-.062-.975l-1.012-.338q-.213.313-.538.5a1.4 1.4 0 0 1-.725.188q-.625 0-1.062-.437A1.45 1.45 0 0 1 0 4.75q0-.625.438-1.062A1.45 1.45 0 0 1 1.5 3.25q.625 0 1.063.438Q3 4.124 3 4.75v.1l1.013.35q.25-.45.668-.763.42-.312.944-.4V2.95a1.56 1.56 0 0 1-.806-.531A1.42 1.42 0 0 1 4.5 1.5q0-.625.438-1.062A1.45 1.45 0 0 1 6 0q.624 0 1.063.438Q7.5.874 7.5 1.5a1.4 1.4 0 0 1-.325.919q-.325.394-.8.531v1.087q.525.088.944.4t.668.763L9 4.85v-.1q0-.625.438-1.062A1.45 1.45 0 0 1 10.5 3.25q.624 0 1.063.438Q12 4.124 12 4.75q0 .624-.437 1.063a1.45 1.45 0 0 1-1.063.437q-.4 0-.731-.187a1.5 1.5 0 0 1-.531-.5L8.225 5.9q.075.487-.062.969-.138.48-.488.881l.712.875q.138-.063.288-.094.15-.03.325-.031.624 0 1.063.438.437.436.437 1.062 0 .624-.437 1.063A1.45 1.45 0 0 1 9 11.5q-.625 0-1.062-.437A1.45 1.45 0 0 1 7.5 10q0-.25.081-.481A1.6 1.6 0 0 1 7.8 9.1l-.712-.887a2.2 2.2 0 0 1-1.094.287A2.2 2.2 0 0 1 4.9 8.213l-.7.887a1.6 1.6 0 0 1 .219.419q.081.23.081.481 0 .624-.437 1.063A1.45 1.45 0 0 1 3 11.5q-.625 0-1.062-.437" />
    </Svg>
  ),
  'dotted-circle': (props: IconPropsWithoutName) => (
    <Svg
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 14 14"
      {...props}
    >
      <path d="M1.402 7.878q.1.383.241.734.142.35.325.666.15.25.117.534a.77.77 0 0 1-.217.466.6.6 0 0 1-.458.175.5.5 0 0 1-.425-.242 7 7 0 0 1-.592-1.1 6.4 6.4 0 0 1-.375-1.2.53.53 0 0 1 .109-.483.56.56 0 0 1 .458-.216q.283 0 .508.183t.309.483m.566-4.066a5 5 0 0 0-.325.666 6 6 0 0 0-.241.734.92.92 0 0 1-.309.483.78.78 0 0 1-.508.183.58.58 0 0 1-.458-.2.49.49 0 0 1-.109-.466q.134-.65.384-1.25.249-.6.6-1.1a.5.5 0 0 1 .416-.225.58.58 0 0 1 .45.175.77.77 0 0 1 .217.466.82.82 0 0 1-.117.534m1.85 7.3a5.7 5.7 0 0 0 1.4.6.95.95 0 0 1 .467.3.75.75 0 0 1 .183.5.555.555 0 0 1-.666.566 7 7 0 0 1-1.192-.367 6.4 6.4 0 0 1-1.108-.583.54.54 0 0 1-.259-.425.6.6 0 0 1 .159-.475.8.8 0 0 1 .483-.233.82.82 0 0 1 .533.117m1.434-9.734a6 6 0 0 0-.709.242 5 5 0 0 0-.675.342.95.95 0 0 1-.558.125.77.77 0 0 1-.492-.225.58.58 0 0 1-.183-.467.51.51 0 0 1 .25-.417q.55-.35 1.142-.591A7 7 0 0 1 5.252.012a.51.51 0 0 1 .45.116q.2.166.2.45a.75.75 0 0 1-.184.5.95.95 0 0 1-.466.3m4.033 9.75a.88.88 0 0 1 .542-.125.77.77 0 0 1 .491.225.6.6 0 0 1 .184.475.48.48 0 0 1-.25.409 6.5 6.5 0 0 1-1.134.591q-.6.242-1.233.375a.56.56 0 0 1-.475-.117.55.55 0 0 1-.208-.45q0-.282.191-.5a1 1 0 0 1 .475-.3q.384-.1.734-.241.349-.143.683-.342m-1.4-9.75a.95.95 0 0 1-.467-.3.75.75 0 0 1-.183-.5q0-.283.2-.45a.51.51 0 0 1 .45-.116q.633.132 1.233.375.6.24 1.134.591a.51.51 0 0 1 .25.417.6.6 0 0 1-.167.467.8.8 0 0 1-.483.233.9.9 0 0 1-.55-.117 7 7 0 0 0-.7-.35 5.5 5.5 0 0 0-.717-.25m3.85 6.484a.92.92 0 0 1 .308-.467.78.78 0 0 1 .509-.183q.283 0 .458.216a.53.53 0 0 1 .108.484 6 6 0 0 1-.391 1.216q-.258.584-.592 1.083a.52.52 0 0 1-.417.234.56.56 0 0 1-.45-.167.77.77 0 0 1-.216-.475.84.84 0 0 1 .116-.541 7 7 0 0 0 .325-.675q.142-.342.242-.725m-.567-4.05a.82.82 0 0 1-.116-.534.77.77 0 0 1 .216-.466.56.56 0 0 1 .45-.167.52.52 0 0 1 .417.233 6.5 6.5 0 0 1 1 2.334.53.53 0 0 1-.125.466.58.58 0 0 1-.458.2.78.78 0 0 1-.509-.183.92.92 0 0 1-.308-.483 6 6 0 0 0-.242-.734 5 5 0 0 0-.325-.666" />
    </Svg>
  ),
  'form-sync': (props: IconPropsWithoutName) => (
    <Svg
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 20 18"
      {...props}
    >
      <path d="M18.1622 11.2432H0.864865C0.61982 11.2432 0.414414 11.1604 0.248649 10.9946C0.0828829 10.8288 0 10.6234 0 10.3784C0 10.1333 0.0828829 9.92793 0.248649 9.76216C0.414414 9.5964 0.61982 9.51351 0.864865 9.51351H18.1622C18.4072 9.51351 18.6126 9.5964 18.7784 9.76216C18.9441 9.92793 19.027 10.1333 19.027 10.3784C19.027 10.6234 18.9441 10.8288 18.7784 10.9946C18.6126 11.1604 18.4072 11.2432 18.1622 11.2432ZM11.2432 6.05405H14.7027L10.3784 1.72973V5.18919C10.3784 5.43423 10.4613 5.63964 10.627 5.80541C10.7928 5.97117 10.9982 6.05405 11.2432 6.05405ZM4.32432 17.2973C3.84865 17.2973 3.44144 17.1279 3.1027 16.7892C2.76396 16.4504 2.59459 16.0432 2.59459 15.5676V13.8378C2.59459 13.5928 2.67748 13.3874 2.84324 13.2216C3.00901 13.0559 3.21441 12.973 3.45946 12.973H15.5676C15.8126 12.973 16.018 13.0559 16.1838 13.2216C16.3496 13.3874 16.4324 13.5928 16.4324 13.8378V15.5676C16.4324 16.0432 16.2631 16.4504 15.9243 16.7892C15.5856 17.1279 15.1784 17.2973 14.7027 17.2973H4.32432ZM3.45946 7.78378C3.21441 7.78378 3.00901 7.7009 2.84324 7.53513C2.67748 7.36937 2.59459 7.16396 2.59459 6.91892V1.72973C2.59459 1.25405 2.76396 0.846847 3.1027 0.508108C3.44144 0.169369 3.84865 0 4.32432 0H10.5297C10.7604 0 10.9802 0.0432432 11.1892 0.12973C11.3982 0.216216 11.582 0.338739 11.7405 0.497297L15.9351 4.69189C16.0937 4.85045 16.2162 5.03423 16.3027 5.24324C16.3892 5.45225 16.4324 5.67207 16.4324 5.9027V6.91892C16.4324 7.16396 16.3496 7.36937 16.1838 7.53513C16.018 7.7009 15.8126 7.78378 15.5676 7.78378H3.45946Z" />
    </Svg>
  ),
} as const;
...
const Icon = (props: IconProps) => {
  if (props.name in icons) {
    return icons[props.name as keyof typeof icons](props);
  }

  // SSO provider icons live in a lazily-loaded chunk (see `./ssoIcons.tsx`).
  return (
    <Suspense fallback={null}>
      <SSOIcon {...props} name={props.name as SSOIconNames} />
    </Suspense>
  );
};
