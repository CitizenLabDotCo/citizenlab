...
describe('<Title />', () => {
  ...
  it('renders with variant h2', () => {
    render(<Title styleVariant="h2">Test title</Title>);
  ...
  it('renders with variant h3', () => {
    render(<Title styleVariant="h3">Test title</Title>);
  ...
  it('renders with variant h4', () => {
    render(<Title styleVariant="h4">Test title</Title>);
  ...
  it('renders with variant h5', () => {
    render(<Title styleVariant="h5">Test title</Title>);
  ...
  it('renders with variant h6', () => {
    render(<Title styleVariant="h6">Test title</Title>);
