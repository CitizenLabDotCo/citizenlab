...
| Timezone abbreviation              | `CET`        | `GMT+1`         | ✅ **Accepted.** Intl cannot emit tz-database abbreviations; `GMT+1` is unambiguous and needs no lookup table. Don't reintroduce one. |
