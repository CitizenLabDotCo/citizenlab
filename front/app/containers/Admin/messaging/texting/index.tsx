...
class TextingCampaigns extends React.PureComponent<Props & InjectedIntlProps> {
...
const TextingCampaignsWithIntl = injectIntl<Props>(TextingCampaigns);

export default (inputProps: Props) => (
  <GetCampaigns withoutCampaignNames={['manual']} pageSize={250}>
    {(campaigns) => <TextingCampaignsWithIntl {...inputProps} {...campaigns} />}
  </GetCampaigns>
);
