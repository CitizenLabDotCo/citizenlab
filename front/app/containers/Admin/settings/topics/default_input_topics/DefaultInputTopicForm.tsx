...
const DefaultInputTopicForm = ({ onSubmit, defaultValues }: Props) => {
    ...
    <Section>
      <FormProvider {...methods}>
        <form
          ...
          data-testid="defaultInputTopicForm"
        >
          <SectionField>
            <Feedback />
          ...
          <Box display="flex">
            <Button
              ...
              id="e2e-submit-default-input-topic-button"
            >
...
export default DefaultInputTopicForm;
