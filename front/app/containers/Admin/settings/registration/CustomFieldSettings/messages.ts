...
export default defineMessages({
  ...
  subtitleBullet2: {
    id: 'app.containers.AdminPage.SettingsPage.subtitleBullet4',
    defaultMessage:
      'The question will be asked <b>by default</b> when people want to engage with a project or sign up for an event. Depending on your license, however, <b>admins and managers can override this per phase</b>- see the “Phase access and user data” tab on each project phase.',
  },
