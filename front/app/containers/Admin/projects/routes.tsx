...
const AdminPhaseOpinionGroups = lazy(() => import('./project/opinionGroups'));
...
const phaseOpinionGroupsRoute = createRoute({
  getParentRoute: () => projectPhasesRoute,
  path: '$phaseId/opinion-groups',
  component: () => (
    <PageLoading>
      <AdminPhaseOpinionGroups />
    </PageLoading>
  ),
});
