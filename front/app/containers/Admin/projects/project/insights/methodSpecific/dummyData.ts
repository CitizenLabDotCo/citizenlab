// Dummy data for Common Ground insights development
...
export const dummyCommonGroundResultsWithGender = {
  data: {
    type: 'common_ground_results' as const,
    id: 'dummy-phase-id',
    attributes: {
...
export const dummyCommonGroundResultsWithAge = {
  data: {
    type: 'common_ground_results' as const,
    id: 'dummy-phase-id',
    attributes: {
...
export const dummyCommonGroundResultsWithDomicile = {
  data: {
    type: 'common_ground_results' as const,
    id: 'dummy-phase-id',
    attributes: {
