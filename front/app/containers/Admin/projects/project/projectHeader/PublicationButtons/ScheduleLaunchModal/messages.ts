...
export default defineMessages({
  ...
  schedule: {
    id: 'app.containers.Admin.projects.projectHeader.ScheduleLaunchModal.schedule',
    defaultMessage: 'Schedule',
  },
  now: {
    id: 'app.containers.Admin.projects.projectHeader.ScheduleLaunchModal.now',
    defaultMessage: 'Now',
  },
  whoCanFindProject: {
  ...
  adminsOnly: {
    id: 'app.containers.Admin.projects.projectHeader.ScheduleLaunchModal.adminsOnly',
