...
export default defineMessages({
  ...
  thisWidgetWillShow: {
    ...
    defaultMessage:
      'This widget will case the projects that are currently published, respecting the ordering defined on the projects page. This behavior is the same as the "active" tab of the "legacy" projects widget.',
  },
});
