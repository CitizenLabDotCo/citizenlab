...
import { confirmPhoneConfirmationCodeChangePhone } from 'api/authentication/confirm_phone/confirmPhoneConfirmationCode';
...
const PhoneChange = () => {
  ...
  const onPhoneConfirmation = async (code: string) => {
    ...
    try {
      ...
      await confirmPhoneConfirmationCodeChangePhone(code);
        ...
        >
          <Box padding="32px">
            ...
            <PhoneConfirmation
              ...
              onResendCode={() =>
                requestPhoneConfirmationCodeChangePhone(phoneValue)
              }
            />
          </Box>
        </Modal>
