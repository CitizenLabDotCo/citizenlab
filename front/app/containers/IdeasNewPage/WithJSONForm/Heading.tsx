...
export const Heading = ({
  ...
  return (
    <>
      {/* Setting margin top doesn't work consistently on android and i-phone */}
      {isSurveyOnMobile && (
        <Box height={isSurveyOnMobile ? mobileHeaderHeight : undefined} />
      )}
      <>
        <Box
          width="100%"
          ...
          height={isSurveyOnMobile ? mobileHeaderHeight : undefined}
          ...
          <Modal opened={showLeaveModal} close={closeModal}>
            <Box display="flex" flexDirection="column" width="100%" p="20px">
              ...
              >
                ...
                >
                  <FormattedMessage
                    {...messages.confirmLeaveSurveyButtonText}
                  />
                </Button>
                <Button
