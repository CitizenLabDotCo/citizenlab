...
import { FormattedMessage, FormattedHTMLMessage as OriginalFormattedHTMLMessage } from 'react-intl';
...
type Props = FormattedMessage.Props;

export default class FormattedHTMLMessage extends React.PureComponent<Props, State> {
  ...
  render() {
    if (this.state.loaded) {
      ...
      return (
        <OriginalFormattedHTMLMessage {...this.props} values={values} />
      );
    }
