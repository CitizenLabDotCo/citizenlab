class Comment < ApplicationRecord
  ...
  counter_culture :idea, column_name: proc {|model| model.published? ? 'comments_count' : nil }
  counter_culture [:idea, :project], column_name: proc {|model| model.published? ? 'comments_count' : nil }
