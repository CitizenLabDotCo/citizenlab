...
import { IInitiativesFilterCounts, initiativesFilterCountsStream } from 'services/initiatives';
import { IQueryParameters } from './GetInitiatives';

type children = (renderProps: GetInitiativesFilterCountsChildProps) => JSX.Element | null;
...
export type GetInitiativesFilterCountsChildProps = IInitiativesFilterCounts | undefined| null;

export default class GetInitiativesFilterCounts extends React.Component<Props, State> {
    ...
    this.subscriptions = [
      this.queryParameters$.pipe(
        ...
        switchMap((queryParameters) => {
          if (queryParameters) {
            return initiativesFilterCountsStream({ queryParameters }).observable;
          }
        ...
        this.setState({
          initiativesFilterCounts: (!isNilOrError(initiativesFilterCounts) ? initiativesFilterCounts : null),
        });
      })
    ];
  }
