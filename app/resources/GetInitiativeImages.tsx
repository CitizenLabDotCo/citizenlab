...
import { IInitiativeImageData, initiativeImagesStream } from 'services/initiativeImages';
...
type children = (renderProps: GetInitiativeImagesChildProps) => JSX.Element | null;
...
export type GetInitiativeImagesChildProps = IInitiativeImageData[] | undefined| null;
  ...
  componentDidMount() {
    ...
    this.subscriptions = [
      this.inputProps$.pipe(
        ...
        this.setState({ initiativeImages: (initiativeImages ? initiativeImages.data : null) });
      })
    ];
  }
