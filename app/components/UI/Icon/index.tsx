...
const icons = {
  close: ({ className, title }: IconProps) => (
  ...
  upload: ({ className, title }: IconProps) => (
  ...
  'upload-file': ({ className, title }: IconProps) => (
    <svg className={className} height="100%" viewBox="0 0 24 16" fill="none">
      {injectTitle(title)}
  ...
  error: ({ className, ariaHidden, title, name }: IconProps) => (
    <Svg
      className={className}
  ...
  checkmark: ({ className, ariaHidden, title, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  'round-checkmark': ({ className, title }: IconProps) => (
  ...
  halt: ({ className, title }: IconProps) => (
  ...
  dropdown: ({ className, title }: IconProps) => (
  ...
  'arrow-back': ({ className, title }: IconProps) => (
  ...
  plus: ({ className, title }: IconProps) => (
  ...
  'plus-circle': ({ className, title }: IconProps) => (
  ...
  'minus-circle': ({ className, title }: IconProps) => (
  ...
  delete: ({ className, title }: IconProps) => (
  ...
  edit: ({ className, title }: IconProps) => (
  ...
  upvote: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  downvote: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  idea2: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  user: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  notification: ({ className, title }: IconProps) => (
  ...
  search2: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  'lock-outlined': ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  facebook: ({ className, title }: IconProps) => (
  ...
  messenger: ({ className, title }: IconProps) => (
    <svg className={className} height="100%" viewBox="96.216 93 2484.567 2500">
      {injectTitle(title)}
  ...
  'facebook-blue': ({ className, title }: IconProps) => (
    <svg className={className} height="100%" viewBox="4.588 4.588 257.717 257.719">
      {injectTitle(title)}
      <path fill="#4B6696" d="M248.082 4.588H18.812c-7.856 0-14.224 6.367-14.224 14.224v229.27c0 7.855 6.366 14.226 14.224 14.226h123.432v-99.803H108.66V123.61h33.584V94.924c0-33.287 20.33-51.413 50.024-51.413 14.225 0 26.45 1.06 30.012 1.533v34.788l-20.596.01c-16.147 0-19.274 7.673-19.274 18.934v24.832h38.515l-5.016 38.895h-33.5v99.803h65.673c7.854 0 14.223-6.37 14.223-14.225V18.813c0-7.858-6.37-14.225-14.224-14.225z" />
    </svg>
  ),
  twitter: ({ className, title }: IconProps) => (
  ...
  comments: ({ className, title }: IconProps) => (
    <svg className={className} height="100%" viewBox="0 0 20 17">
      {injectTitle(title)}
      <g>
  ...
  info: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  calendar: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
      name={name}
      viewBox="6.5 -4 11.701 13"
    >
  ...
  power: ({ className, title }: IconProps) => (
  ...
  admin: ({ className, title }: IconProps) => (
  ...
  settings: ({ className, title }: IconProps) => (
  ...
  project: ({ className, title }: IconProps) => (
  ...
  position: ({ className, title }: IconProps) => (
  ...
  project2: ({ className, title }: IconProps) => (
  ...
  notification_comment: ({ className, title }: IconProps) => (
  ...
  notification_mention: ({ className, title }: IconProps) => (
  ...
  'more-options': ({ className, title }: IconProps) => (
  ...
  phase_arrow: ({ className, title }: IconProps) => (
  ...
  mapmarker: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  timeline: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  survey: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={className}
      ariaHidden={ariaHidden}
      title={title}
  ...
  download: ({ className, title }: IconProps) => (
  ...
  notification_invitation_accepted: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="#6B6B6B">
      {injectTitle(title)}
  ...
  notification_status: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="#6B6B6B">
      {injectTitle(title)}
  ...
  arrowLeft: ({ className, title }: IconProps) => (
    <svg className={className} width="16" height="12" viewBox="0 0 16 12" fill="none">
      {injectTitle(title)}
  ...
  create: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="31" height="31" viewBox="0 0 31 31" fill="none">
      {injectTitle(title)}
  ...
  shield: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} viewBox="0 0 21 24">
      {injectTitle(title)}
  ...
  blankPage: ({ className, title }: IconProps) => (
  ...
  mailBig: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="60" height="40" viewBox="0 0 60 40" fill="none">
      {injectTitle(title)}
  ...
  remove: ({ className, title }: IconProps) => (
  ...
  add: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="23" height="23" viewBox="0 0 23 23" fill="none">
      {injectTitle(title)}
  ...
  circleInfo: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="23" height="23" viewBox="0 0 23 23" fill="none">
      {injectTitle(title)}
  ...
  paperclip: ({ className, title }: IconProps) =>  (
    <svg className={`cl-icon ${className ? className : ''}`} viewBox="0 0 10 20" fill="none">
      {injectTitle(title)}
  ...
  code: ({ className, title }: IconProps) =>  (
    <svg className={`cl-icon ${className ? className : ''}`} width="17" height="10" viewBox="0 0 17 10" fill="none">
      {injectTitle(title)}
  ...
  questionMark: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
  ...
  noAvatar: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={`cl-icon ${className ? className : ''}`}
      ariaHidden={ariaHidden}
      title={title}
  ...
  completeProfile: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={`cl-icon ${className ? className : ''}`}
      ariaHidden={ariaHidden}
      title={title}
    ...
    >
      ...
      <defs>
        <linearGradient id="paint0_linear" x1="43.68" x2="6.72" y2="48.16" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fff" /><stop offset="1" stopColor="#fff" stopOpacity=".34" />
        </linearGradient>
      </defs>
    </Svg>
  ),
  setup: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="42" height="42" viewBox="0 0 42 42" fill="none">
      ...
      <path d="M32.375 0H9.625C4.31725 0 0 4.319 0 9.625V32.375C0 37.681 4.31725 42 9.625 42H32.375C37.6828 42 42 37.681 42 32.375V9.625C42 4.319 37.6828 0 32.375 0ZM29.75 21C29.75 21.2975 29.5995 21.574 29.3493 21.7367L17.0993 29.6117C16.954 29.7045 16.7895 29.75 16.625 29.75C16.4797 29.75 16.3363 29.7132 16.205 29.6415C15.925 29.491 15.75 29.1952 15.75 28.875V13.125C15.75 12.8048 15.925 12.509 16.205 12.3585C16.4867 12.2027 16.828 12.215 17.0975 12.39L29.3475 20.265C29.5995 20.426 29.75 20.7025 29.75 21Z" fill="url(#paint0_linear)" fillOpacity="0.3" />
      <defs>
        <linearGradient id="paint0_linear" x1="34.3636" y1="3.18182" x2="7.63636" y2="42" gradientUnits="userSpaceOnUse">
  ...
  engage: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="42" height="42" viewBox="0 0 42 42" fill="none">
      {injectTitle(title)}
      <circle cx="21" cy="21" r="21" fill="url(#paint0_linear)" fillOpacity="0.3" />
  ...
  manage: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="42" height="42" viewBox="0 0 42 42" fill="none">
      {injectTitle(title)}
      <circle cx="21" cy="21" r="21" fill="url(#paint0_linear)" fillOpacity="0.3" />
  ...
  decide: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="42" height="42" viewBox="0 0 42 42" fill="none">
      {injectTitle(title)}
      <circle cx="21" cy="21" r="21" fill="url(#paint0_linear)" fillOpacity="0.3" />
  ...
  showMore: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="20" height="18" viewBox="0 0 20 18" fill="none">
      {injectTitle(title)}
  ...
  translate: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="16" height="15" viewBox="0 0 16 15" fill="none">
      {injectTitle(title)}
  ...
  share: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="20" height="20" viewBox="0 0 20 20">
      {injectTitle(title)}
  ...
  similarIdeas: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="23" height="23" viewBox="0 0 23 23" fill="none">
      {injectTitle(title)}
  ...
  play: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="19" height="19" viewBox="0 0 19 19" fill="none">
      {injectTitle(title)}
      <path className="cl-icon-fill cl-icon-primary Play-icon" d="M14.6458 0H4.35417C1.95304 0 0 1.95383 0 4.35417V14.6458C0 17.0462 1.95304 19 4.35417 19H14.6458C17.047 19 19 17.0462 19 14.6458V4.35417C19 1.95383 17.047 0 14.6458 0ZM13.4583 9.5C13.4583 9.63458 13.3903 9.75967 13.277 9.83329L7.73537 13.3958C7.66967 13.4377 7.59525 13.4583 7.52083 13.4583C7.45513 13.4583 7.39021 13.4417 7.33083 13.4093C7.20417 13.3412 7.125 13.2074 7.125 13.0625V5.9375C7.125 5.79262 7.20417 5.65883 7.33083 5.59075C7.45829 5.52029 7.61267 5.52583 7.73458 5.605L13.2763 9.1675C13.3903 9.24033 13.4583 9.36542 13.4583 9.5Z" fill={theme.clIconPrimary} />
    </svg>
  ),
  lightingBolt: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="47" height="47" viewBox="0 0 47 47">
      {injectTitle(title)}
  ...
  lightingBolt2: ({ className, title }: IconProps) => (
    <svg className={`${className}`} height="100%" viewBox="0 0 15 30" fill="none">
      {injectTitle(title)}
      <path d="M0 0v16.5h4.5V30L15 12H9l6-12H0z" />
    </svg>
  ),
  database: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="64" height="64" viewBox="0 0 64 64" fill="none">
      {injectTitle(title)}
      <circle className="cl-icon-background Background-Database-icon" cx="32" cy="32" r="32" fill={theme.clIconBackground} />
  ...
  menu: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="17" height="14" viewBox="0 0 17 14" fill="none">
      {injectTitle(title)}
  ...
  moveFolder: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="23" height="24" viewBox="0 0 23 24" fill="none">
      {injectTitle(title)}
  ...
  trash: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="14" height="19" viewBox="0 0 14 19" fill="none">
      {injectTitle(title)}
      <g className="Trash-icon">
        <path className="cl-icon-primary container-icon" d="M0 12.6667C0 13.8331 0.895 14.7778 2 14.7778H10C11.105 14.7778 12 13.8331 12 12.6667V0H0V12.6667Z" transform="translate(1 4.22217)" fill={theme.clIconPrimary} />
        <path className="cl-icon-accent top-icon" d="M10.5 1.05556H14V3.16667H0V1.05556H3.5L4.5 0H9.5L10.5 1.05556Z" fill={theme.clIconAccent} />
      </g>
    </svg>
  ),
  userExport: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none">
      {injectTitle(title)}
      <g className="User-Export-icon">
        ...
        <g className="cl-icon-accent Database-user-icon" fill={theme.clIconAccent}>
  ...
  setting: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="25" height="26" viewBox="0 0 25 26" fill="none">
      {injectTitle(title)}
  ...
  ideas: ({ className, title, ariaHidden, name, theme }: IconProps) => (
    <Svg
      className={`cl-icon ${className ? className : ''}`}
      ariaHidden={ariaHidden}
      title={title}
  ...
  initiatives: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={`cl-icon ${className ? className : ''}`}
      ariaHidden={ariaHidden}
      title={title}
  ...
  folder: ({ className, title, ariaHidden, name, theme }: IconProps) => (
    <Svg
      className={`cl-icon ${className ? className : ''}`}
      ariaHidden={ariaHidden}
      title={title}
  ...
  users: ({ className, title, theme }: IconProps) => (
  ...
  stats: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="27" height="25" viewBox="0 0 27 25" fill="none">
      {injectTitle(title)}
      <g className="Stats-icon">
        ...
        <g className="cl-icon-primary Segment-1-icon" transform="translate(1 2.01292)" stroke={theme.clIconPrimary} fill={theme.clIconPrimary}>
  ...
  charts: ({ className, title }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="14" height="12" viewBox="0 0 14 12" fill="none">
      {injectTitle(title)}
  ...
  invitations: ({ className, title, theme }: IconProps) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="25" height="25" viewBox="0 0 25 25" fill="none">
      {injectTitle(title)}
      ...
      <g className="cl-icon-primary Invitations-envelope-icon" fill={theme.clIconPrimary}>
  ...
  moneybag: ({ className, title }: IconProps) => (
    <svg className={className} height="100%" viewBox="0 0 19 24">
      {injectTitle(title)}
  ...
  submit: ({ className, title }: IconProps) => (
  ...
  homeFilled: ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      className={`cl-icon ${className ? className : ''}`}
      ariaHidden={ariaHidden}
      title={title}
  ...
  info3: ({ className, title }: IconProps) => (
  ...
  dot: ({ className, title }: IconProps) => (
    <svg className={className} width="7" height="7" viewBox="0 0 7 7">
      {injectTitle(title)}
      <circle cx="3.5" cy="3.5" r="3.5" />
    </svg>
  ),
  pen: ({ className, title }: IconProps) => (
  ...
  clLogo: ({ className, title }: IconProps) => (
    <svg className={className} width="10.436" height="13.33" viewBox="0 0 10.436 13.33">
      {injectTitle(title)}
      <path d="M7.744 0H0v4.07c0 1.792.221 3.398.701 4.705.406 1.12.959 2.091 1.66 2.838.037.038.074.075.074.112.295.299.59.561.922.783.037.038.074.038.074.075 0 0 .037 0 .037.038 0 0 .037 0 .037.037.737.485 1.364.598 1.438.635l.221.037.221-.037c.074 0 .406-.075.923-.336.626-.299 1.217-.785 1.732-1.307.701-.748 1.254-1.719 1.66-2.838.479-1.345.7-2.913.7-4.705v-.075-1.83c.036-.224.036-.411.036-.56V0H7.744zM1.217 3.062v-1.83H4.61v1.344l-1.253 1.27h-2.14v-.784zm3.392 8.737c-.11-.074-.258-.148-.369-.224h-.036s-.037 0-.037-.038c-.037 0-.037-.037-.074-.037a5.969 5.969 0 0 1-.737-.635l-.111-.111c-.59-.635-1.033-1.419-1.364-2.391-.332-.932-.553-2.052-.627-3.285h2.102l1.253 1.27v5.451zM5.2 5.228l-.738-.748.738-.746.737.746-.737.748zm3.355 3.135c-.331.972-.811 1.756-1.4 2.391a5.167 5.167 0 0 1-1.365 1.045V6.348l1.253-1.27h2.139c-.074 1.233-.258 2.315-.627 3.285zm.627-7.056v2.502H7.043L5.79 2.539V1.232h3.392v.075z"/>
    </svg>
  ),
  pencil: ({ className, title }: IconProps) => (
    <svg className={className} width="15" height="15" viewBox="0 0 15 15">
      {injectTitle(title)}
  ...
  profile1: ({ className, title }: IconProps) => (
    <svg className={className} width="23" height="23" viewBox="0 0 23 23">
      {injectTitle(title)}
  ...
  filter: ({ className, title }: IconProps) => (
    <svg className={className} height="100%" viewBox="0 0 20.508 15.776">
      {injectTitle(title)}
  ...
  successStory: ({ className, title }: IconProps) => (
    <svg className={className} width="17" height="27" viewBox="0 0 17 27">
      {injectTitle(title)}
  ...
  clock: ({ className, title }: IconProps) => (
  ...
  bullseye: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 31 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
  ...
  'envelope-check': ({ className, title, ariaHidden, name }: IconProps) => (
    <Svg
      ariaHidden={ariaHidden}
      title={title}
      name={name}
  ...
  template: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 23 23" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
  ...
  scratch: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 17 21" height="100%"fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
  ...
  list: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 17 14" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
      <path d="M0 9h4V5H0v4zm0 5h4v-4H0v4zM0 4h4V0H0v4zm5 5h12V5H5v4zm0 5h12v-4H5v4zM5 0v4h12V0H5z" />
    </svg>
  ),
  link: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 20 10" height="100%" fill="none"xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
  ...
  purpose: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 22 23" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
  ...
  participationLevel: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
  ...
  key: ({ className, title }: IconProps) => (
    <svg className={className} viewBox="0 0 31 31" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
