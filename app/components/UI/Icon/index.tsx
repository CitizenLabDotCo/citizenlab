...
const icons = {
  ...
  comments: (props: IconProps) => (
    <Svg {...props} viewBox="0 0 20 17">
      <g>
        <path d="M20 11.077C20 8.277 17.309 6 14 6s-6 2.277-6 5.077 2.691 5.077 6 5.077c.618 0 1.236-.084 1.838-.248l1.982 1.05a.389.389 0 0 0 .451-.067.445.445 0 0 0 .1-.469l-.543-1.438C19.194 14.023 20 12.586 20 11.077z" /><path d="M14.41 5.25v-.022a.45.45 0 0 0 .127.027H14.564A.435.435 0 0 0 15 4.818a.433.433 0 0 0-.081-.255C13.904 1.829 10.996 0 7.642 0 3.428 0 0 2.943 0 6.562c0 1.943.977 3.744 2.695 4.996l-.902 1.809a.436.436 0 0 0 .607.575l2.311-1.323a8.643 8.643 0 0 0 1.938.443.415.415 0 0 0 .375-.143.445.445 0 0 0 .1-.391 5.063 5.063 0 0 1-.137-1.154C6.986 7.998 10.316 5.25 14.41 5.25z" />
      </g>
    </Svg>
  ),
