    ...
    case 'logo': {
      return (
        <svg width="151" height="28">
          <path id="a" fill-rule="evenodd" d="M18.777 10.313c-.147 2.488-.566 4.72-1.246 6.64-.688 1.94-1.646 3.58-2.846 4.87-.83.892-1.79 1.623-2.78 2.12v-11.08l2.532-2.55h4.34zm-11.88 0l2.532 2.55v11.07c-.255-.127-.508-.27-.757-.427l-.016-.01-.05-.03c-.022-.017-.045-.03-.065-.044-.05-.032-.098-.065-.146-.098l-.02-.014c-.545-.374-1.064-.814-1.543-1.305l-.018-.02c-.05-.05-.1-.103-.15-.155-1.2-1.29-2.157-2.928-2.845-4.87-.68-1.92-1.1-4.156-1.247-6.647h4.323zm-4.384-7.78H9.43v2.74l-2.534 2.55H2.513v-5.29zm16.324.126c.002.864.004 2.633-.004 5.08H14.43l-2.532-2.55V2.534h6.94v.125zm-6.662 6.408l-1.51 1.52-1.508-1.52 1.51-1.52 1.508 1.52zM21.35 3.33c0-.978 0-1.518.004-2.08L21.35.004h-5.482c-.388 0-.815 0-1.272-.002C13.37 0 11.978-.003 10.482.008c-1.28.01-2.575.005-3.718 0C6.18.007 5.63.005 5.136.005H0v8.233c0 3.633.488 6.853 1.452 9.572.805 2.27 1.942 4.206 3.38 5.75l.183.192.024.025c.593.61 1.24 1.156 1.92 1.625l.022.014c.062.043.123.084.188.126.027.018.055.035.082.054.022.013.044.028.066.04l.018.013c1.546.975 2.775 1.24 2.91 1.267l.43.086.432-.086c.135-.027.858-.19 1.86-.682 1.276-.63 2.504-1.556 3.55-2.682 1.438-1.545 2.575-3.48 3.38-5.75.963-2.718 1.452-5.936 1.452-9.566v-.153c.006-1.52.004-2.737.002-3.715V3.33z"/>
          <path id="b" fill-rule="evenodd" d="M42.532 12.853c1.81 0 2.658 1.16 2.987 2.29l3.26-1.103c-.575-2.29-2.658-4.583-6.33-4.583-3.92 0-6.99 3.01-6.99 7.205 0 4.168 3.126 7.205 7.1 7.205 3.59 0 5.7-2.32 6.303-4.583l-3.207-1.076c-.3 1.05-1.233 2.292-3.097 2.292-1.864 0-3.453-1.38-3.453-3.838 0-2.457 1.562-3.81 3.425-3.81z"/>
          <path id="c" fill-rule="evenodd" d="M51 23.453h3.646V9.87H51v13.583z"/>
          <path id="d" fill-rule="evenodd" d="M50.562 5.427c0 1.215 1.014 2.236 2.246 2.236 1.26 0 2.248-1.02 2.248-2.236 0-1.27-.987-2.29-2.248-2.29-1.233-.002-2.246 1.02-2.246 2.29z"/>
          <path id="e" fill-rule="evenodd" d="M62.483 5.813h-3.29v1.905c0 1.215-.657 2.153-2.08 2.153h-.687v3.26h2.44v6.32c0 2.623 1.644 4.196 4.275 4.196 1.07 0 1.727-.193 2.056-.33v-3.037c-.192.054-.685.11-1.124.11-1.04 0-1.59-.388-1.59-1.575V13.13h2.714V9.87h-2.713V5.814z"/>
          <path id="f" fill-rule="evenodd" d="M67.744 23.453h3.645V9.87h-3.646v13.583z"/>
          <path id="g" fill-rule="evenodd" d="M67.306 5.427c0 1.215 1.014 2.236 2.247 2.236 1.26 0 2.248-1.02 2.248-2.236 0-1.27-.986-2.29-2.247-2.29-1.233-.002-2.247 1.02-2.247 2.29z"/>
          <path id="h" fill-rule="evenodd" d="M84.954 23.453V20.25h-6.687l6.578-7.314V9.872h-10.88v3.174h6.22l-6.384 7.177v3.23h11.154z"/>
          <path id="i" fill-rule="evenodd" d="M96.327 18.65l3.042.91c-.686 2.347-2.824 4.307-6.14 4.307-3.7 0-6.96-2.678-6.96-7.26 0-4.334 3.18-7.15 6.632-7.15 4.165 0 6.66 2.678 6.66 7.04 0 .524-.055 1.076-.055 1.13H89.86c.082 1.796 1.59 3.093 3.398 3.093 1.7 0 2.63-.856 3.07-2.07zm-6.385-3.533h6.03c-.055-1.353-.933-2.68-3.016-2.68-1.89.002-2.93 1.437-3.014 2.68z"/>
          <path id="j" fill-rule="evenodd" d="M105.536 15.64c0-1.572.93-2.815 2.52-2.815 1.755 0 2.495 1.187 2.495 2.705v7.923h3.646v-8.557c0-2.982-1.535-5.383-4.878-5.383-1.453 0-3.07.635-3.892 2.042V9.87h-3.535v13.583h3.646V15.64z"/>
          <path id="k" fill-rule="evenodd" d="M117.594 23.453h2.576V3.467h-2.576v19.986z"/>
          <path id="l" fill-rule="evenodd" d="M123.184 19.892c0-2.374 1.727-3.7 4-4.03l3.564-.525c.795-.11 1.014-.524 1.014-.994 0-1.297-.85-2.373-2.85-2.373-1.81 0-2.823 1.13-2.987 2.677l-2.467-.58c.274-2.54 2.55-4.306 5.4-4.306 3.946 0 5.48 2.265 5.48 4.86v6.652c0 1.16.11 1.85.164 2.18h-2.52c-.056-.33-.138-.827-.138-1.793-.575.937-1.89 2.207-4.248 2.207-2.685 0-4.412-1.877-4.412-3.975zm4.77 1.794c2.11 0 3.808-1.02 3.808-3.92v-.607l-4.03.606c-1.094.166-1.917.8-1.917 1.988 0 .994.823 1.932 2.138 1.932z"/>
          <path id="m" fill-rule="evenodd" d="M140.34 23.453h-2.55V3.467h2.55v8.585c.63-1.187 2.164-2.264 4.357-2.264 4 0 6.056 3.092 6.056 6.957 0 3.947-2.22 7.067-6.14 7.067-1.944 0-3.45-.856-4.274-2.29v1.93zm7.782-6.708c0-2.87-1.507-4.665-3.892-4.665-2.274 0-3.918 1.794-3.918 4.665 0 2.87 1.644 4.748 3.918 4.748 2.358 0 3.892-1.877 3.892-4.748z"/>
        </svg>
      );
    }
    case 'close': {
