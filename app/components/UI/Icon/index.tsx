...
const icons = {
  ...
  'round-checkmark': (className, title, ariaHidden) => (
    <svg aria-hidden={ariaHidden} role="img" className={className} height="100%" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
  ...
  halt: (className, title, ariaHidden) => (
    <svg aria-hidden={ariaHidden} role="img" className={className} viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
...
const clIcons = {
  ...
  clock: (className, title, _theme, ariaHidden) => (
    <svg role="img" aria-hidden={ariaHidden} className={className} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
  ...
  bullseye: (className, title, _theme, ariaHidden) => (
    <svg role="img" aria-hidden={ariaHidden} className={className} viewBox="0 0 31 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
  ...
  'envelope-check': (className, title, _theme, ariaHidden) => (
    <svg role="img" aria-hidden={ariaHidden} className={className} viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
