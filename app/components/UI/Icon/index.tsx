...
const icons = {
  ...
  'minus-circle': (props: IconProps) => (
    <Svg {...props} width="18" height="18" viewBox="0 0 18 18">
      <g className="ic_remove_circle_48px">
        <path className="Vector" d="M9 0C4.0275 0 0 4.0275 0 9C0 13.9725 4.0275 18 9 18C13.9725 18 18 13.9725 18 9C18 4.0275 13.9725 0 9 0ZM13.5 9.9H4.5V8.1H13.5V9.9Z" fill="#FC3C2D" />
      </g>
    </Svg>
  ),
  delete: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 12 14">
  ...
  edit: (props: IconProps) => (
    <Svg {...props} viewBox="0 0 12 12">
      <path fillRule="evenodd" d="M0 9.3v2.448h2.448L9.67 4.525 7.223 2.077 0 9.3zm11.557-6.66c.255-.256.255-.67 0-.925L10.033.19c-.255-.254-.67-.254-.924 0L7.914 1.386l2.447 2.448 1.195-1.194z" />
    </Svg>
  ),
  ...
  create: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="31" height="31" viewBox="0 0 31 31">
  ...
  shield: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 21 24">
  ...
  shieldVerified: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 24 24">
  ...
  blankPage: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="53" height="70" viewBox="0 0 53 70">
      <g className="Blank-Page-icon">
        <path className="Fillin-Paper-icon" d="M8.5 7.75L17 0H51V66H0V17.5L8.5 7.75Z" transform="translate(2 1)" fill="rgba(1, 161, 177, 0.2)" />
  ...
  mailBig: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="60" height="40" viewBox="0 0 60 40">
      <path d="M53.75 0H6.25A6.259 6.259 0 0 0 0 6.25v27.5A6.259 6.259 0 0 0 6.25 40h47.5A6.259 6.259 0 0 0 60 33.75V6.25A6.259 6.259 0 0 0 53.75 0zm-31.7 22.21l-15 12.5c-.232.195-.518.29-.8.29a1.252 1.252 0 0 1-.803-2.212l15-12.5c.53-.44 1.32-.368 1.763.16.442.532.37 1.322-.16 1.762zm7.95.332a6.98 6.98 0 0 1-3.953-1.232L5.546 7.283a1.252 1.252 0 0 1-.327-1.738 1.246 1.246 0 0 1 1.737-.325l20.502 14.027a4.476 4.476 0 0 0 5.083 0L53.042 5.22a1.25 1.25 0 0 1 1.413 2.063L33.953 21.31A6.98 6.98 0 0 1 30 22.543zM54.71 34.55a1.244 1.244 0 0 1-1.76.16l-15-12.5a1.252 1.252 0 0 1-.16-1.762c.443-.528 1.23-.6 1.763-.16l15 12.5c.527.442.6 1.232.157 1.762z" fill="#01A1B1" fillOpacity=".25" />
    </Svg>
  ),
  remove: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 18 18">
      <path d="M9 0C4.027 0 0 4.027 0 9s4.027 9 9 9 9-4.027 9-9-4.027-9-9-9zm4.5 9.9h-9V8.1h9v1.8z" />
    </Svg>
  ),
  circleInfo: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="23" height="23" viewBox="0 0 23 23">
      <path d="M11.5 0C5.159 0 0 5.159 0 11.5C0 17.841 5.159 23 11.5 23C17.841 23 23 17.841 23 11.5C23 5.159 17.841 0 11.5 0ZM11.5 19C10.949 19 10.5 18.552 10.5 18C10.5 17.448 10.949 17 11.5 17C12.051 17 12.5 17.448 12.5 18C12.5 18.552 12.051 19 11.5 19ZM15 9.258C15 10.18 14.626 11.081 13.975 11.733L12.733 12.975C12.267 13.439 12 14.084 12 14.742V15.5C12 15.776 11.776 16 11.5 16C11.224 16 11 15.776 11 15.5V14.742C11 13.82 11.374 12.919 12.025 12.267L13.267 11.025C13.733 10.561 14 9.916 14 9.258V8.5C14 7.121 12.878 6 11.5 6C10.122 6 9 7.121 9 8.5V9.5C9 9.776 8.776 10 8.5 10C8.224 10 8 9.776 8 9.5V8.5C8 6.57 9.57 5 11.5 5C13.43 5 15 6.57 15 8.5V9.258Z" fill="#32B67A" />
    </Svg>
  ),
  paperclip: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 10 20">
  ...
  code: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="17" height="10" viewBox="0 0 17 10">
  ...
  questionMark: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 17.391 20">
  ...
  questionMarkRoundedOutlined: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 20 20">
  ...
  noAvatar: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 56 56">
  ...
  completeProfile: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 56 56">
      <circle cx="28" cy="28" r="28" fill="url(#completeProfile)" fillOpacity=".5" />
      ...
      <defs>
        <linearGradient id="completeProfile" x1="43.68" x2="6.72" y2="48.16" gradientUnits="userSpaceOnUse">
  ...
  setup: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="42" height="42" viewBox="0 0 42 42">
      <path d="M32.375 0H9.625C4.31725 0 0 4.319 0 9.625V32.375C0 37.681 4.31725 42 9.625 42H32.375C37.6828 42 42 37.681 42 32.375V9.625C42 4.319 37.6828 0 32.375 0ZM29.75 21C29.75 21.2975 29.5995 21.574 29.3493 21.7367L17.0993 29.6117C16.954 29.7045 16.7895 29.75 16.625 29.75C16.4797 29.75 16.3363 29.7132 16.205 29.6415C15.925 29.491 15.75 29.1952 15.75 28.875V13.125C15.75 12.8048 15.925 12.509 16.205 12.3585C16.4867 12.2027 16.828 12.215 17.0975 12.39L29.3475 20.265C29.5995 20.426 29.75 20.7025 29.75 21Z" fill="white" />
      <path d="M32.375 0H9.625C4.31725 0 0 4.319 0 9.625V32.375C0 37.681 4.31725 42 9.625 42H32.375C37.6828 42 42 37.681 42 32.375V9.625C42 4.319 37.6828 0 32.375 0ZM29.75 21C29.75 21.2975 29.5995 21.574 29.3493 21.7367L17.0993 29.6117C16.954 29.7045 16.7895 29.75 16.625 29.75C16.4797 29.75 16.3363 29.7132 16.205 29.6415C15.925 29.491 15.75 29.1952 15.75 28.875V13.125C15.75 12.8048 15.925 12.509 16.205 12.3585C16.4867 12.2027 16.828 12.215 17.0975 12.39L29.3475 20.265C29.5995 20.426 29.75 20.7025 29.75 21Z" fill="url(#setup)" fillOpacity="0.3" />
      <defs>
        <linearGradient id="setup" x1="34.3636" y1="3.18182" x2="7.63636" y2="42" gradientUnits="userSpaceOnUse">
  ...
  decide: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="42" height="42" viewBox="0 0 42 42">
      ...
      <rect x="17.4875" y="15.3658" width="4.97561" height="14.3415" fill="#84939E" fillOpacity="0.75" />
      <rect x="23.707" y="11.2684" width="4.97561" height="18.439" fill="#84939E" />
      <rect x="11.2679" y="20.488" width="4.97561" height="9.21951" fill="#84939E" fillOpacity="0.5" />
      <defs>
        <linearGradient id="decide" x1="34.3636" y1="3.18182" x2="7.63636" y2="42" gradientUnits="userSpaceOnUse">
          <stop stopColor="#84939E" />
          <stop offset="1" stopColor="#84939E" stopOpacity="0" />
          <stop offset="1" stopColor="#84939E" stopOpacity="0.69" />
        </linearGradient>
  ...
  showMore: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="20" height="18" viewBox="0 0 20 18">
  ...
  translate: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="16" height="15" viewBox="0 0 16 15">
  ...
  share: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="20" height="20" viewBox="0 0 20 20">
      <path fill="#84939E" d="M16.666 13.334c-1.153 0-2.17.588-2.77 1.482L6.465 11.1c.123-.346.202-.712.202-1.1s-.08-.754-.202-1.1l7.432-3.716A3.33 3.33 0 0 0 20 3.333 3.336 3.336 0 0 0 16.666 0a3.336 3.336 0 0 0-3.332 3.333c0 .387.078.754.201 1.1L6.104 8.149a3.33 3.33 0 0 0-2.77-1.483A3.338 3.338 0 0 0 0 10a3.337 3.337 0 0 0 3.333 3.334c1.154 0 2.171-.59 2.77-1.483l7.432 3.716a3.27 3.27 0 0 0-.201 1.1 3.336 3.336 0 0 0 3.332 3.334A3.338 3.338 0 0 0 20 16.666a3.336 3.336 0 0 0-3.334-3.332z" />
    </Svg>
  ),
  similarIdeas: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="23" height="23" viewBox="0 0 23 23">
      <path d="M11.5 0C5.159 0 0 5.159 0 11.5S5.159 23 11.5 23 23 17.841 23 11.5 17.841 0 11.5 0zM8 8.5v6a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-4C8.673 7 8 7.673 8 8.5zm9 9a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v9z" fill="#84939E" />
    </Svg>
  ),
  play: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="19" height="19" viewBox="0 0 19 19">
      <path className="cl-icon-fill cl-icon-primary Play-icon" d="M14.6458 0H4.35417C1.95304 0 0 1.95383 0 4.35417V14.6458C0 17.0462 1.95304 19 4.35417 19H14.6458C17.047 19 19 17.0462 19 14.6458V4.35417C19 1.95383 17.047 0 14.6458 0ZM13.4583 9.5C13.4583 9.63458 13.3903 9.75967 13.277 9.83329L7.73537 13.3958C7.66967 13.4377 7.59525 13.4583 7.52083 13.4583C7.45513 13.4583 7.39021 13.4417 7.33083 13.4093C7.20417 13.3412 7.125 13.2074 7.125 13.0625V5.9375C7.125 5.79262 7.20417 5.65883 7.33083 5.59075C7.45829 5.52029 7.61267 5.52583 7.73458 5.605L13.2763 9.1675C13.3903 9.24033 13.4583 9.36542 13.4583 9.5Z" fill={props.colorTheme?.clIconPrimary} />
    </Svg>
  ),
  lightingBolt: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="47" height="47" viewBox="0 0 47 47">
      <circle className="cl-icon-background Background-SmartFlash-icon" cx="23.5" cy="23.5" r="23.5" fill={props.colorTheme?.clIconBackground} />
      <path className="cl-icon-fill cl-icon-primary SmartFlash-icon" d="M 0 0L 0 12.1172L 3.525 12.1172L 3.525 22.0312L 11.75 8.8125L 7.05 8.8125L 11.75 0L 0 0Z" transform="translate(17.625 13.2188)" fill={props.colorTheme?.clIconPrimary} />
    </Svg>
  ),
  ...
  moderation: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} viewBox="0 0 45 45">
      ...
      <g>
        <path className="cl-icon-primary" fill={props.colorTheme?.clIconPrimary} d="M14.025 9.317a.471.471 0 00-.443.31l-5.65 15.537-.028.161v9.417c0 .52.421.941.942.941h27.308c.52 0 .942-.421.942-.941v-9.418l-.028-.16-5.65-15.538a.471.471 0 00-.443-.31zm.33.941h16.29l5.308 14.596h-8.745c-.26 0-.47.211-.47.471v2.825h-8.476v-2.825c0-.26-.21-.47-.47-.47H9.047z" />
        <path className="cl-icon-accent" fill={props.colorTheme?.clIconAccent} d="M27.208 14.025a.47.47 0 00-.333.138l-6.258 6.259-2.492-2.492a.47.47 0 10-.666.665l2.825 2.825a.47.47 0 00.666 0l6.591-6.591a.47.47 0 00-.333-.804z" />
      </g>
    </Svg>
  ),
  ...
  charts: (props: IconProps) => (
    <Svg {...props} className={`cl-icon ${props.className ? props.className : ''}`} width="14" height="12" viewBox="0 0 14 12">
  ...
  verify_light: (props: IconProps) => (
    <Svg {...props} viewBox="0 0 51 56">
      <path fill="url(#verify_light)" fillOpacity=".5" d="M49.404 7.506L24.991.04a.935.935 0 00-.545.002L.653 7.508A.934.934 0 000 8.4v24.267c0 10.156 16.114 20.561 24.752 23.29a.95.95 0 00.556 0c8.639-2.729 24.753-13.134 24.753-23.29V8.4a.935.935 0 00-.657-.894z" />
      <path fill="#fff" d="M20.771 31.83l-6.64-6.857L11.88 27.3l8.892 9.185L39.88 16.75l-2.253-2.327L20.77 31.831z" />
      <defs>
        <linearGradient id="verify_light" x1="50.061" x2="-.535" y1="-5.49" y2="55.557" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fff" />
  ...
  verify_dark: (props: IconProps) => (
    <Svg {...props} viewBox="0 0 51 56">
      <path fill="url(#verify_dark)" fillOpacity=".5" d="M49.404 7.506L24.991.04a.935.935 0 00-.545.002L.653 7.508A.934.934 0 000 8.4v24.267c0 10.156 16.114 20.561 24.752 23.29a.95.95 0 00.556 0c8.639-2.729 24.753-13.134 24.753-23.29V8.4a.935.935 0 00-.657-.894z" />
      <path fill="#fff" d="M20.771 31.83l-6.64-6.857L11.88 27.3l8.892 9.185L39.88 16.75l-2.253-2.327L20.77 31.831z" />
      <defs>
        <linearGradient id="verify_dark" x1="50.061" x2="-.535" y1="-5.49" y2="55.557" gradientUnits="userSpaceOnUse">
          <stop stopColor="#84939E" />
  ...
  'basket-checkmark': (props: IconProps) => (
    <Svg {...props} width="55" height="39" fill="none"  viewBox="0 0 55 39" >
      ...
      <circle cx="39.7044" cy="14.6279" r="14.1279" fill="#32B67A" stroke="#fff"/>
      <path d="M36.4044 17.957l-4.2934-4.3321-1.4621 1.4648 5.7555 5.8074L48.7597 8.4305 47.308 6.9657 36.4044 17.957z" fill="#fff"/>
    </Svg>
  ),
