...
create: (className, title) => (
  ...
  {injectTitle(title)}
    <circle className="cl-icon-background Background-Create-icon" cx="15.5" cy="15.5" r="15.5" fill="#01A1B1" fillOpacity="0.15" />
...
blankPage: (className, title) => (
  ...
  <g id="Blank-Page-icon">
    <path id="Fillin-Paper-icon" d="M8.5 7.75L17 0H51V66H0V17.5L8.5 7.75Z" transform="translate(2 1)" fill="#01A1B1" fillOpacity="0.2" />
...
const clIcons = {
  ...
  database: (className, title, theme) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
        <circle className="cl-icon-background" id="Background-Database-icon" cx="32" cy="32" r="32" fill={theme.clIconBackground} fillOpacity="0.07" />
