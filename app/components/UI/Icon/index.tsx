...
const icons = {
  ...
  questionMark: (className, title) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="21" height="100%" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      {injectTitle(title)}
      <path d="M18.667 0H2.333C1.044 0 0 1.023 0 2.286v16c0 1.263 1.044 2.285 2.333 2.285H7L10.5 24l3.5-3.429h4.667c1.289 0 2.333-1.022 2.333-2.285v-16C21 1.023 19.956 0 18.667 0zm-7 18.286H9.333V16h2.334v2.286zm2.409-8.852l-1.044 1.052c-.84.823-1.365 1.514-1.365 3.228H9.333v-.571c0-1.263.525-2.406 1.365-3.234l1.453-1.44c.42-.412.682-.983.682-1.612 0-1.263-1.044-2.286-2.333-2.286-1.29 0-2.333 1.023-2.333 2.286H5.833c0-2.526 2.089-4.571 4.667-4.571s4.667 2.045 4.667 4.571a3.59 3.59 0 0 1-1.091 2.577z" />
    </svg>
  ),
