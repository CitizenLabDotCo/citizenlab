...
const icons = {
  ...
  lightingBolt: (className, title) => (
    <svg className={`cl-icon ${className ? className : ''}`} width="47" height="47" viewBox="0 0 47 47" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      {injectTitle(title)}
      <circle className="cl-icon-background" id="Background-SmartFlash-icon" cx="23.5" cy="23.5" r="23.5" fill="rgba(255, 103, 47, .1)" />
      <path className="cl-icon-fill cl-icon-primary" id="SmartFlash-icon" d="M 0 0L 0 12.1172L 3.525 12.1172L 3.525 22.0312L 11.75 8.8125L 7.05 8.8125L 11.75 0L 0 0Z" transform="translate(17.625 13.2188)" fill="#FF672F" />
    </svg>
  ),
  database: (className, title) => (
