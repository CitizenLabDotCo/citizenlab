...
const getIcon = (name: string, className: string | undefined) => {
  switch (name) {
    ...
    case 'google-colored': {
      return (
        <svg className={className} height="100%" viewBox="0 0 21 21">
          <title>
            search (1)
          </title>
          <desc>
          ...
          <use transform="translate(0 5.67)" fill="#FBBB00"/>
          <use transform="translate(10.73 8.54)" fill="#518EF8"/>
          <use transform="translate(1.25 12.69)" fill="#28B446"/>
          <use transform="translate(1.17)" fill="#F14336"/>
          <defs>
            <path id="a" d="M4.654 7.02l-.73 2.728-2.673.057C.454 8.325 0 6.63 0 4.83 0 3.087.423 1.445 1.174 0l2.38.436L4.593 2.8c-.217.636-.336 1.32-.336 2.03 0 .77.14 1.508.396 2.19z"/>
            <path id="b" d="M10.086 0c.12.635.183 1.29.183 1.962 0 .75-.08 1.485-.23 2.192-.512 2.407-1.847 4.508-3.697 5.996l-2.997-.154-.424-2.647C4.15 6.63 5.11 5.502 5.615 4.153H0V0h10.087z"/>
            <path id="c" d="M15.822 5.997c-1.8 1.447-4.085 2.312-6.573 2.312-4 0-7.477-2.236-9.25-5.525L3.403 0c.886 2.367 3.17 4.05 5.846 4.05 1.15 0 2.227-.31 3.152-.853l3.42 2.8z"/>
            <path id="d" d="M16.028 2.417l-3.4 2.785c-.96-.598-2.09-.944-3.302-.944-2.737 0-5.063 1.762-5.905 4.214L0 5.672C1.748 2.3 5.268 0 9.326 0c2.548 0 4.884.908 6.702 2.417z"/>
          </defs>
        </svg>
      );
    }
