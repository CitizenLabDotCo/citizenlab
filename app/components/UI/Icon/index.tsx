...
const icons = {
  ...
  checkmark: (className, title, theme) => (
  ...
  dropdown: (className, title, theme) => (
  ...
  'arrow-back': (className, title, theme) => (
  ...
  'plus-circle': (className, title, theme) => (
    <svg className={className} height="100%" viewBox="2 2 20 20">
      {injectTitle(title)}
      <path fill="none" d="M0 0h24v24H0V0z" />
  ...
  'minus-circle': (className, title, theme) => (
  ...
  'upvote-2': (className, title, theme) => (
  ...
  downvote: (className, title, theme) => (
    <svg className={className} height="100%" viewBox="0 0 24 24" width="24">
      {injectTitle(title)}
      <path d="M0 0h24v24H0z" fill="none" />
  ...
  'downvote-2': (className, title, theme) => (
  ...
  'upvote-outline': (className, title, theme) => (
    <svg className={className} height="100%" viewBox="0 0 24 24">
      {injectTitle(title)}
      <path fill="none" d="M0 0h24v24H0V0z" />
  ...
  'chevron-right': (className, title, theme) => (
  ...
  'downvote-outline': (className, title, theme) => (
    <svg className={className} height="100%" viewBox="0 0 24 24">
      {injectTitle(title)}
      <path fill="none" d="M0 0h24v24H0V0z" />
  ...
  notification: (className, title, theme) => (
  ...
  'lock-outlined': (className, title, theme) => (
  ...
  facebook: (className, title, theme) => (
  ...
  'facebook-blue': (className, title, theme) => (
    <svg className={className} height="100%" viewBox="4.588 4.588 257.717 257.719">
      {injectTitle(title)}
      <path fill="#4B6696" d="M248.082 4.588H18.812c-7.856 0-14.224 6.367-14.224 14.224v229.27c0 7.855 6.366 14.226 14.224 14.226h123.432v-99.803H108.66V123.61h33.584V94.924c0-33.287 20.33-51.413 50.024-51.413 14.225 0 26.45 1.06 30.012 1.533v34.788l-20.596.01c-16.147 0-19.274 7.673-19.274 18.934v24.832h38.515l-5.016 38.895h-33.5v99.803h65.673c7.854 0 14.223-6.37 14.223-14.225V18.813c0-7.858-6.37-14.225-14.224-14.225z" />
    </svg>
  ),
  twitter: (className, title, theme) => (
  ...
  comments: (className, title, theme) => (
  ...
  calendar: (className, title, theme) => (
  ...
  settings: (className, title, theme) => (
  ...
  position: (className, title, theme) => (
  ...
  project2: (className, title, theme) => (
  ...
  notification_comment: (className, title, theme) => (
  ...
  notification_mention: (className, title, theme) => (
  ...
  'google-colored': (className, title, theme) => (
  ...
  'more-options': (className, title, theme) => (
  ...
  phase_arrow: (className, title, theme) => (
  ...
  mapmarker: (className, title, theme) => (
  ...
  timeline: (className, title, theme) => (
  ...
  comments2: (className, title, theme) => (
  ...
  'comments-outline': (className, title, theme) => (
    <svg className={className} height="100%" viewBox="2 2 20 20">
      {injectTitle(title)}
  ...
  download: (className, title, theme) => (
  ...
  notification_invitation_accepted: (className, title, theme) => (
  ...
  notification_status: (className, title, theme) => (
    <svg className={className} viewBox="0 0 24 24" version="1.1" fill="#6B6B6B">
      {injectTitle(title)}
      <g id="surface1">
  ...
  arrowLeft: (className, title, theme) => (
  ...
  blankPage: (className, title, theme) => (
...
const Icon: React.SFC<Props> = ({ name, className, title, colorTheme }) => {
  ...
  return icons[name](className, title, theme);
};
