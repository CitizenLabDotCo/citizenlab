...
const icons = {
  ...
  'upload-file': (className, title) => (
    <svg className={className} height="100%" viewBox="0 0 24 16" fill="none">
      {injectTitle(title)}
      <path fill-rule="evenodd" clip-rule="evenodd" d="M19.355 6.035A7.5 7.5 0 0 0 12 0a7.506 7.506 0 0 0-6.65 4.035A6.003 6.003 0 0 0 0 10c0 3.315 2.685 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.055-4.78-4.645-4.965zM14 9v4h-4V9H7l5-5 5 5h-3z"/>
    </svg>
  ),
