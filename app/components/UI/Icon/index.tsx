...
const icons = {
  ...
  messenger: (className, title) => (
    <svg className={className} version="1.1" id="Messenger_Mark" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="1000px" height="1000px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" >
      {title && <title>{title}</title>}
