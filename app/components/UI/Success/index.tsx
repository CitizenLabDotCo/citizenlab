...
const StyledSuccessMessageInner = styled.div<{ showBackground: boolean }>`
  ...
  background: ${(props) =>
    props.showBackground ? colors.clGreenSuccessBackground : 'transparent'};
  padding: 10px 13px;
`;
...
export default class Success extends PureComponent<Props, State> {
  ...
  render() {
    ...
    const showIcon = isBoolean(this.props.showIcon)
      ? this.props.showIcon
      : true;
    const showBackground = isBoolean(this.props.showBackground)
