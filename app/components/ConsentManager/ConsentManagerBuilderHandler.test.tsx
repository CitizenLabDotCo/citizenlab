...
const returningUser = (tenantBlacklistedDestinationIds, isPriviledged, oldTenantDestinations, wasPrivileged) => ({
  setPreferences,
  resetPreferences,
  saveConsent,
  destinations,
...
const returningUserNewDestinations = (tenantBlacklistedDestinationIds, isPriviledged, oldTenantDestinations, wasPrivileged) => {
  return {
    setPreferences,
    resetPreferences,
    saveConsent,
  ...
  describe('classifies detinations into categories: ', () => {
    ...
    describe('Normal User', () => {
      it('...without a blacklist', () => {
        const wrapper = shallow(<ConsentManagerBuilderHandler {...firstTimeUser(emptyBlacklist, false)} />);
        const { categorizedDestinations } = wrapper.find('Container').props();

        expect(new Set(categorizedDestinations.functional.map(destination => destination.id)))
          .toEqual(new Set(['FunctionalTool']));

        expect(new Set(categorizedDestinations.advertising.map(destination => destination.id)))
      ...
      it('...with a blacklist', () => {
        const wrapper = shallow(<ConsentManagerBuilderHandler {...firstTimeUser(blacklist, false)} />);
        const { categorizedDestinations } = wrapper.find('Container').props();
    ...
    describe('Admin User', () => {
      it('...without a blacklist', () => {
        const wrapper = shallow(<ConsentManagerBuilderHandler {...firstTimeUser(emptyBlacklist, true)} />);
        const { categorizedDestinations } = wrapper.find('Container').props();
      ...
      it('...with a blacklist', () => {
        const wrapper = shallow(<ConsentManagerBuilderHandler {...firstTimeUser(blacklist, true)} />);
        const { categorizedDestinations } = wrapper.find('Container').props();
    ...
    describe('first time user', () => {
      describe('normal user', () => {
        ...
        it('all non admin destinations on the blacklist: doesn\'t expect consent, saves', () => {
          const wrapper = shallow(
            <ConsentManagerBuilderHandler {...firstTimeUser(everyNonAdminDestinationIds, false)} />
          );
          const { isConsentRequired } = wrapper.find('Container').props();
      ...
      describe('admin user', () => {
        ...
        it('all non admin destinations on the blacklist: expects consent', () => {
          const wrapper = shallow(
            <ConsentManagerBuilderHandler {...firstTimeUser(everyNonAdminDestinationIds, true)} />
          );
          const { isConsentRequired } = wrapper.find('Container').props();
          expect(isConsentRequired).toEqual(true);
          expect(saveConsent).toHaveBeenCalledTimes(0);
        ...
        it('all destinations on the blacklist: expects consent', () => {
          const wrapper = shallow(
            <ConsentManagerBuilderHandler {...firstTimeUser(destinationIds, true)} />
          );
          const { isConsentRequired } = wrapper.find('Container').props();
          expect(isConsentRequired).toEqual(false);
          expect(saveConsent).toHaveBeenCalledTimes(1);
    ...
    describe('returing user', () => {
      describe('normal user', () => {
        describe('without new destinations', () => {
          it('no blacklist: doesn\'t expect consent nor saves', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(emptyBlacklist, false, emptyBlacklist, false)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(false);
            expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          describe('unchanged tenant blacklist', () => {
            it('doesn\'t expect consent nor saves', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUser(blacklist, false, blacklist, false)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('all but admin destinations: doesn\'t expect consent nor saves', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUser(everyNonAdminDestinationIds, false, everyNonAdminDestinationIds, false)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('all: doesn\'t expect consent nor saves', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUser(destinationIds, false, destinationIds, false)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          describe('changed tenant blacklist', () => {
            describe('additions', () => {
              it('from non to some: doesn\'t expect consent, saves', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(blacklist, false, emptyBlacklist, false)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(false);
                expect(saveConsent).toHaveBeenCalledTimes(1);
              ...
              it('from none to all but admin destinations blacklist: doesn\'t expect consent, saves', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(everyNonAdminDestinationIds, false, emptyBlacklist, false)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(false);
                expect(saveConsent).toHaveBeenCalledTimes(1);
              ...
              it('from some to all but admin destinations blacklist: doesn\'t expect consent, saves', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(everyNonAdminDestinationIds, false, blacklist, false)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(false);
                expect(saveConsent).toHaveBeenCalledTimes(1);
              ...
              it('from non to all: doesn\'t expect consent, saves', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(destinationIds, false, emptyBlacklist, false)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(false);
                expect(saveConsent).toHaveBeenCalledTimes(1);
            ...
            describe('removals', () => {
              it('from some to none: expects consent, doesn\'t save', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(emptyBlacklist, false, blacklist, false)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(true);
                expect(saveConsent).toHaveBeenCalledTimes(0);
              ...
              it('from all to none: expects consent, doesn\'t save', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(emptyBlacklist, false, destinationIds, false)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(true);
                expect(saveConsent).toHaveBeenCalledTimes(0);
        ...
        describe('with new destinations', () => {
          it('no blacklist: expects consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUserNewDestinations(emptyBlacklist, false, emptyBlacklist, false)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(true);
            expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          describe('unchanged tenant blacklist', () => {
            it('expects consent, doesn\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations(blacklist, false, blacklist, false)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(true);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('all but admin destinations: expects consent, doesn\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations(everyNonAdminDestinationIds, false, everyNonAdminDestinationIds, false)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(true);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('new destination is on the black list: doesn\'t expect consent, doesn\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations([...destinationIds, 'NewTool'], false, [...destinationIds, 'NewTool'], false)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          describe('changed tenant blacklist', () => {
            it('from non to some: expects consent, does\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations(blacklist, false, emptyBlacklist, false)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(true);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('new destination was added to the blacklist: does\t expect consent, saves', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations([...blacklist, 'NewTool'], false, blacklist, false)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(1);
            ...
            it('new destination was removed from the blacklist: expects consent, does\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations(blacklist, false, [...blacklist, 'NewTool'], false)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(true);
              expect(saveConsent).toHaveBeenCalledTimes(0);
      ...
      describe('admin user (same as normal)', () => {
        describe('without new destinations', () => {
          it('no blacklist: doesn\'t expect consent nor saves', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(emptyBlacklist, true, emptyBlacklist, true)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(false);
            expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          describe('unchanged tenant blacklist', () => {
            it('doesn\'t expect consent nor saves', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUser(blacklist, true, blacklist, true)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('all but admin destinations: doesn\'t expect consent nor saves', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUser(everyNonAdminDestinationIds, true, everyNonAdminDestinationIds, true)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('all: doesn\'t expect consent nor saves', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUser(destinationIds, true, destinationIds, true)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          describe('changed tenant blacklist', () => {
            describe('additions', () => {
              it('from non to some: doesn\'t expect consent, saves', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(blacklist, true, emptyBlacklist, true)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(false);
                expect(saveConsent).toHaveBeenCalledTimes(1);
              ...
              it('from none to all but admin destinations blacklist: doesn\'t expect consent, saves', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(everyNonAdminDestinationIds, true, emptyBlacklist, true)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(false);
                expect(saveConsent).toHaveBeenCalledTimes(1);
              ...
              it('from some to all but admin destinations blacklist: doesn\'t expect consent, saves', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(everyNonAdminDestinationIds, true, blacklist, true)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(false);
                expect(saveConsent).toHaveBeenCalledTimes(1);
              ...
              it('from non to all: doesn\'t expect consent, saves', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(destinationIds, true, emptyBlacklist, true)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(false);
                expect(saveConsent).toHaveBeenCalledTimes(1);
            ...
            describe('removals', () => {
              it('from some to none: expects consent, doesn\'t save', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(emptyBlacklist, true, blacklist, true)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(true);
                expect(saveConsent).toHaveBeenCalledTimes(0);
              ...
              it('from all to none: expects consent, doesn\'t save', () => {
                const wrapper = shallow(
                  <ConsentManagerBuilderHandler {...returningUser(emptyBlacklist, true, destinationIds, true)} />
                );
                const { isConsentRequired } = wrapper.find('Container').props();
                expect(isConsentRequired).toEqual(true);
                expect(saveConsent).toHaveBeenCalledTimes(0);
        ...
        describe('with new destinations', () => {
          it('no blacklist: expects consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUserNewDestinations(emptyBlacklist, true, emptyBlacklist, true)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(true);
            expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          describe('unchanged tenant blacklist', () => {
            it('expects consent, doesn\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations(blacklist, true, blacklist, true)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(true);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('all but admin destinations: expects consent, doesn\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations(everyNonAdminDestinationIds, true, everyNonAdminDestinationIds, true)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(true);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('new destination is on the black list: doesn\'t expect consent, doesn\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations([...destinationIds, 'NewTool'], true, [...destinationIds, 'NewTool'], true)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          describe('changed tenant blacklist', () => {
            it('from non to some: expects consent, does\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations(blacklist, true, emptyBlacklist, true)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(true);
              expect(saveConsent).toHaveBeenCalledTimes(0);
            ...
            it('new destination was added to the blacklist: doesn\'t expect consent, saves', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations([...blacklist, 'NewTool'], true, blacklist, true)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(false);
              expect(saveConsent).toHaveBeenCalledTimes(1);
            ...
            it('new destination was removed from the blacklist: expects consent, doesn\'t save', () => {
              const wrapper = shallow(
                <ConsentManagerBuilderHandler {...returningUserNewDestinations(blacklist, true, [...blacklist, 'NewTool'], true)} />
              );
              const { isConsentRequired } = wrapper.find('Container').props();
              expect(isConsentRequired).toEqual(true);
              expect(saveConsent).toHaveBeenCalledTimes(0);
      ...
      describe('changing role', () => {
        describe('no blacklist', () => {
          it('from normal to admin: asks consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(emptyBlacklist, true, emptyBlacklist, false)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(true);
            expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          it('from admin to normal: doesn\'t ask for consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(emptyBlacklist, false, emptyBlacklist, true)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(false);
            expect(saveConsent).toHaveBeenCalledTimes(0);
        ...
        describe('stable blacklist', () => {
          it('from normal to admin: asks consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(blacklist, true, blacklist, false)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(true);
            expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          it('from admin to normal: doesn\'t ask for consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(blacklist, false, blacklist, true)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(false);
            expect(saveConsent).toHaveBeenCalledTimes(0);
        ...
        describe('all blacklisted but admin destinations', () => {
          it('from normal to admin: asks consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(everyNonAdminDestinationIds, true, everyNonAdminDestinationIds, false)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(true);
            expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          it('from admin to normal: doesn\'t ask for consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(everyNonAdminDestinationIds, false, everyNonAdminDestinationIds, true)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(false);
            expect(saveConsent).toHaveBeenCalledTimes(0);
        ...
        describe('all blacklisted', () => {
          it('from normal to admin: doesn\'t ask for consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(destinationIds, true, destinationIds, false)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(false);
            expect(saveConsent).toHaveBeenCalledTimes(0);
          ...
          it('from admin to normal: doesn\'t ask for consent, doesn\'t save', () => {
            const wrapper = shallow(
              <ConsentManagerBuilderHandler {...returningUser(destinationIds, false, destinationIds, true)} />
            );
            const { isConsentRequired } = wrapper.find('Container').props();
            expect(isConsentRequired).toEqual(false);
            expect(saveConsent).toHaveBeenCalledTimes(0);
