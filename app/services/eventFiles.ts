...
export function eventFilesStream(eventId: string, streamParams: IStreamParams | null = null) {
  return streams.get<IEventFiles>({ apiEndpoint: `${apiEndpoint}/${eventId}/files`, ...streamParams });
}

export function eventFileStream(eventId: string, fileId: string, streamParams: IStreamParams | null = null) {
