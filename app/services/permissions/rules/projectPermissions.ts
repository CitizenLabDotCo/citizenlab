...
definePermissionRule('project', 'create', (_project: IProjectData, user: IUser) => {
  return isAdmin(user);
});

definePermissionRule('project', 'delete', (_project: IProjectData, user: IUser) => {
  return isAdmin(user);
});
...
definePermissionRule('project', 'moderate', (project: IProjectData, user: IUser) => {
