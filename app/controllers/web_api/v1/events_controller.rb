class WebApi::V1::EventsController < ApplicationController
  ...
  def show
    render json: WebApi::V1::Fast::EventSerializer.new(@event, params: fastjson_params).serialized_json
  end
  ...
  def create
    ...
    if @event.save
      ...
      render json: WebApi::V1::Fast::EventSerializer.new(@event, params: fastjson_params).serialized_json, status: :created
    else
  ...
  def update
    ...
    if @event.save
      ...
      render json: WebApi::V1::Fast::EventSerializer.new(@event, params: fastjson_params).serialized_json, status: :ok
    else
      render json: { errors: @event.errors.details }, status: :unprocessable_entity
    end
  end
