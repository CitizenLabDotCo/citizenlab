...
class DashboardPageReports extends PureComponent<PropsHithHoCs, State> {
...
// const DashboardPageReportsWithHOCs = injectTracks<Props>({})(localize<Props & Tracks>(injectIntl(DashboardPageReports)));
