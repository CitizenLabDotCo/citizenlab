...
import { IResolution, GraphCard, GraphCardInner, GraphCardHeader, GraphCardTitle, NoDataContainer, GraphCardFigureContainer, GraphCardFigure, GraphCardFigureChange } from '../..';
