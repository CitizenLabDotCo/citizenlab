export default {
  ...
  createProjectFromScratchTabSelected: "'Create a project from scratch' tab selected",
  createProjectFromTemplateTabSelected: "'Create a project from a template' tab selected",
