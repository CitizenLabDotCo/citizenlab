  ...
  renderFormikQuillMultiloc = (props) => {
    return (
      <FormikQuillMultiloc
        ...
        labelTooltip={<Tooltip content={<FormattedMessage {...messages.nameVariablesInfo} />} />}
        noVideos
        noAlign
        {...props}
      />
        ...
        <StyledSection>
          ...
          <SectionField>
            <Label>
              ...
              <Tooltip content={<FormattedMessage {...messages.fieldSenderTooltip} />} />
            </Label>
            <FastField
              name="sender"
          ...
          <SectionField>
            <Label>
              ...
              <Tooltip content={<FormattedMessage {...messages.fieldToTooltip} />} />
            </Label>
            <GetGroups>
          ...
          <SectionField>
            <Label>
              ...
              <Tooltip content={<FormattedMessage {...messages.fieldReplyToTooltip} />} />
            </Label>
            <FastField
              name="reply_to"
        ...
        <StyledSection>
          ...
          <SectionField>
            <FastField
              ...
              labelTooltip={<Tooltip content={<FormattedMessage {...messages.fieldSubjectTooltip} />} />}
              maxCharCount={80}
            />
