...
// const getIdeaRequestContent(ideaMultiloc, titleMultiloc, images, attachments);
...
export function* postIdea(action) {
  ...
  const { ideaMultiloc, titleMultiloc, images, attachments } = action;

  // merge relevant fields to match API request body format
  const requestBody = getIdeaRequestContent(ideaMultiloc, titleMultiloc, images, attachments);
