...
class PhaseExpenses extends PureComponent<Props, State> {
  ...
  render() {
    ...
    if (!isNilOrError(phase) && phase.attributes.participation_method === 'budgeting') {
...
export default (inputProps: InputProps) => (
  <Data {...inputProps}>
    {dataProps => <PhaseExpenses {...inputProps} {...dataProps} />}
  </Data>
);
