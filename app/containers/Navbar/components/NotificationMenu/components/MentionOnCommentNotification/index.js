...
const MentionOnCommentNotification = ({ notification, clearNotification, locale, className }) => (<LinkContainerStyled
...
MentionOnCommentNotification.propTypes = {
...
export default styled(MentionOnCommentNotification)`
