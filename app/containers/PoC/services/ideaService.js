...
export function observeSingleIdea(id, localProperties = false) {
  return Streams.create(`${API_PATH}/ideas/${id}`, null, localProperties);
}

export function observeMultipleIdeas(queryParameters = null, localProperties = false) {
  return Streams.create(`${API_PATH}/ideas`, queryParameters, localProperties);
}

export function observeIdeaRelationShips(idea) {
...
export function toggleIdea(observers, ideaID) {
