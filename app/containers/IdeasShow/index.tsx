...
export class IdeasShow extends PureComponent<Props & InjectedIntlProps & InjectedLocalized, State> {
  ...
  static getDerivedStateFromProps(nextProps: Props, prevState: State) {
    ...
    if (!actionInfos && !isNilOrError(idea) && !isNilOrError(project) && !isUndefined(phases)) {
      ...
      const votingEnabled = idea.attributes.action_descriptor.data.voting.enabled;
      const cancellingEnabled = idea.attributes.action_descriptor.data.voting.cancelling_enabled;
      const votingFutureEnabled = idea.attributes.action_descriptor.data.voting.future_enabled;
