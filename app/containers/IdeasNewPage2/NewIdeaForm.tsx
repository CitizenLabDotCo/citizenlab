...
export default class NewIdeaForm extends PureComponent<Props, State> {
  ...
  handleIdeaFormOutput = async (ideaFormOutput: IIdeaFormOutput) => {
    ...
    const { title, description, selectedTopics, budget, address, imageFile, ideaFiles, ideaFilesToRemove } = ideaFormOutput;
    ...
    this.globalState.set({ title, description, selectedTopics, budget, address, imageFile, imageChanged, ideaFiles, ideaFilesToRemove });
    this.props.onSubmit();
  }
