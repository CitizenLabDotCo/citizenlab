class WebApi::V1::IdeaSerializer < ActiveModel::Serializer
  ...
  def action_descriptor
    ...
    comment_voting_disabled_reason = @participation_context_service.voting_disabled_reason_for_comment(object, current_user)
    {
      commenting: {
      ...
      comment_voting: {
        ...
        future_enabled: comment_voting_disabled_reason && @participation_context_service.future_comment_voting_enabled_phase(object.project, current_user)&.start_at
      },
      budgeting: {
