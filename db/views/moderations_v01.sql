...
FROM ideas
UNION ALL
SELECT id, 'Initiative' moderatable_type, slug AS context_slug, 'Idea' context_type, title_multiloc AS context_multiloc, body_multiloc AS content_multiloc, published_at as created_at 
FROM initiatives
UNION ALL
