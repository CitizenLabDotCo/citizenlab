...
ActiveRecord::Schema.define(version: 20180103163513) do
  ...
  create_view "shared_extensions.geography_columns",  sql_definition: <<-SQL
  ...
  create_view "shared_extensions.geometry_columns",  sql_definition: <<-SQL
  ...
  create_view "shared_extensions.raster_columns",  sql_definition: <<-SQL
  ...
  create_view "shared_extensions.raster_overviews",  sql_definition: <<-SQL
