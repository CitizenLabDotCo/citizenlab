...
MAINTAINER Koen Gremmelprez <koen@citizenlab.co>
...
RUN apt-get update && apt-get install -qq -y --no-install-recommends \
      build-essential nodejs libpq-dev file imagemagick curl git optipng jpegoptim pngquant libgeos-dev
...
COPY engines/onboarding ./engines/onboarding/
