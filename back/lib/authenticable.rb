...
# After https://github.com/nsarno/knock/blob/master/lib/knock/authenticable.rb.
#
...
# the token payload.
module Authenticable # TODO: add specs, create module (Auth or JwtAuth)?
  ...
  def fetch_entity_from_token(entity_class)
    AuthToken.new(token: token).entity_for(entity_class)
