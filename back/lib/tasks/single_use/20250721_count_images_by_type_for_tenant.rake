  ...
  task :count_images_by_type, %i[host date] => [:environment] do |_t, args|
    ...
    Apartment::Tenant.switch(args[:host].tr('.', '_')) do
      ...
      IdeaFile.all.each do |idea_file|
        ...
        idea_files_of_image_type += 1 if image_extensions.include?(extension)
      end
      ...
      Files::File.all.each do |file|
        ...
        files_of_image_type += 1 if image_extensions.include?(extension)
      end
      ...
      EventFile.all.each do |event_file|
        ...
        event_files_of_image_type += 1 if image_extensions.include?(extension)
      end
      ...
      ProjectFile.all.each do |project_file|
        ...
        project_files_of_image_type += 1 if image_extensions.include?(extension)
      end
      ...
      PhaseFile.all.each do |phase_file|
        ...
        phase_files_of_image_type += 1 if image_extensions.include?(extension)
      end
      ...
      ProjectFolders::File.all.each do |project_folders_file|
        ...
        project_folders_files_of_image_type += 1 if image_extensions.include?(extension)
      end
      ...
      StaticPageFile.all.each do |static_page_file|
        ...
        static_page_files_of_image_type += 1 if image_extensions.include?(extension)
      end
      ...
      Files::FilesProject.all.each do |files_project|
        ...
        files_project_files_of_image_type += 1 if image_extensions.include?(extension)
      end
