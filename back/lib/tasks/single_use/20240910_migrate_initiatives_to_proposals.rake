...
def rake_20240910_migrate_project_title_multiloc
  multiloc = {
    ...
    "nb" => "Publiser ideen din her og sett det på agendaen til {styledOrgName}",
...
def rake_20240910_migrate_project_description_multiloc
  ...
  multiloc_content = {
    ...
    "nb" => "Du har et forslag som du ønsker å sende inn til {orgName}. Er du nysgjerrig på om andre også støtter det? Publiser det her, få {constraints}, og {orgName} vil komme tilbake til deg {link}",
  ...
  multiloc_constraints = {
    ...
    "nb" => "{voteThreshold} stemmer innen {daysLimit} dager",
  ...
  multiloc_link = {
    ...
    "nb" => "Lær mere om hvordan borger forslag fungerer.",
...
def rake_20240910_migrate_homepage_description_multiloc
  multiloc = {
    ...
    "nb" => "Publiser forslaget ditt på platformen. Hent støtte fra andre innbyggere og sett forslaget på agendaen. Du kan også se andres forslag.",
