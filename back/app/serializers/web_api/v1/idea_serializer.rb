class WebApi::V1::IdeaSerializer < WebApi::V1::BaseSerializer
  ...
  attribute :action_descriptor do |object, params|
    ...
    upvoting_disabled_reason = @participation_context_service.upvoting_disabled_reason_for_idea(object, current_user(params))
    cancelling_upvotes_disabled_reason = @participation_context_service.cancelling_upvotes_disabled_reason_for_idea(object, current_user(params))
    downvoting_disabled_reason = @participation_context_service.downvoting_disabled_reason_for_idea(object, current_user(params))
    cancelling_downvotes_disabled_reason = @participation_context_service.cancelling_downvotes_disabled_reason_for_idea(object, current_user(params))
...

    {
      ...
      voting_idea: {
        ...
        down: {
          ...
          cancelling_enabled: !cancelling_downvotes_disabled_reason
        }
      },
      comment_voting_idea: {
