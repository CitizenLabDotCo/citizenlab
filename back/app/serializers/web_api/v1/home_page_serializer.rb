...
class WebApi::V1::HomePageSerializer < WebApi::V1::BaseSerializer
  ...
  attribute :top_info_section_multiloc, if: proc { |object, _|
    ...
    TextImageService.new.render_data_images_multiloc object.top_info_section_multiloc, :top_info_section_multiloc
  end

  attribute :bottom_info_section_multiloc, if: proc { |object, _|
    object.bottom_info_section_multiloc.present?
  } do |object|
    TextImageService.new.render_data_images_multiloc object.bottom_info_section_multiloc, :bottom_info_section_multiloc
  end
