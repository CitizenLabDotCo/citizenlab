...
class SideFxInitiativeService
  ...
  def after_create(initiative, user)
    initiative.update!(body_multiloc: TextImageService.new.swap_data_images_multiloc(initiative.body_multiloc, :body_multiloc))
  ...
  def before_update(initiative, user)
    initiative.body_multiloc = TextImageService.new.swap_data_images_multiloc(initiative.body_multiloc, :body_multiloc)
