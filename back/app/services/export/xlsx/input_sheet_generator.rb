    ...
    class InputSheetGenerator
      ...
      def meta_report_fields
        [].tap do |meta_fields|
          ...
          meta_fields << published_at_report_field if participation_method.supports_posting?
          ...
          meta_fields << input_url_report_field if participation_method.supports_posting?
