...
module Permissions
  class PermissionsFieldsService
    ...
    #     else
    #       # Insert default fields to all other permitted_by values
    #       default_fields = default_fields(permitted_by: @permission.permitted_by)
    #       insert_default_fields(fields: default_fields)
    #     end
    #   end
    # end
    ...
    def enable_default_permissions_fields
      if custom_permitted_by_enabled?
        ...
        permissions.each do |permission|
          if !permission.global_custom_fields && permission.permitted_by == 'everyone_confirmed_email'
            ...
            # Insert default fields to all other permitted_by values
            fields = default_fields(permitted_by: permission.permitted_by)
          end
