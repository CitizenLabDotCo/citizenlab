module Permissions
  class ProjectPermissionsService < PhasePermissionsService
    ...
    def initialize(project, user, user_requirements_service: nil, author_hash: nil)
      ...
      super(phase, user, user_requirements_service: user_requirements_service, author_hash: author_hash)
      @project ||= project
    end
