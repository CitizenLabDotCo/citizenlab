...
module Permissions
  class ProjectPermissionsService < Permissions::PermissionsService
    def action_descriptor(project, user)
      ...
      liking_disabled_reason = denied_reason_for_project project, user, 'reacting_idea', reaction_mode: 'up'
      disliking_disabled_reason = denied_reason_for_project project, user, 'reacting_idea', reaction_mode: 'down'
