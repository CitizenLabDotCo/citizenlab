module Permissions
  class ProjectPermissionsService < PhasePermissionsService
    ...
    def initialize(project, user, user_requirements_service: nil, browser_hashes: nil)
      ...
      super(phase, user, user_requirements_service: user_requirements_service, browser_hashes: browser_hashes)
      @project ||= project
    end
