...
module Files
  ...
  #
  # This service extracts text content from supported file formats and uses
  # RubyLLM to generate concise descriptions in all configured locales.
  # The descriptions are stored in the file's description_multiloc field.
  #
  # @example Basic usage
  ...
  class DescriptionGenerator
    ...
    class << self
      ...
      # status simpler for the initial implementation. To retry a job, the existing
      # tracker must be deleted first.
      #
