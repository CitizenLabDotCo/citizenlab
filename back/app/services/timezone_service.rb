...
class TimezoneService
  # These are the timezones that are both supported by the backend (TZInfo::Timezone.all_identifiers)
  # and the frontend (https://momentjs.com/timezone/).
  ...
  def dst?(tzinfo)
    !!tzinfo.current_period.local_ends_at
  end
end
