...
class SideFxCustomFieldService
  ...
  def after_create(custom_field, current_user)
    custom_field.update! description_multiloc: TextImageService.new.swap_data_images_multiloc(custom_field.description_multiloc, :description_multiloc)
  ...
  def before_update(custom_field, _current_user)
    custom_field.description_multiloc = TextImageService.new.swap_data_images_multiloc(custom_field.description_multiloc, :description_multiloc)
  end
