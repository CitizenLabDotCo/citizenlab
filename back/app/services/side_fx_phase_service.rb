...
class SideFxPhaseService
  ...
  def after_create(phase, user)
    ...
    phase.update!(description_multiloc: TextImageService.new.swap_data_images_multiloc(phase.description_multiloc, :description_multiloc))
  ...
  def before_update(phase, user)
    phase.description_multiloc = TextImageService.new.swap_data_images_multiloc(phase.description_multiloc, :description_multiloc)
