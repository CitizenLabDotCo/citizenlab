...
class SideFxProjectService
  ...
  def after_create(project, user)
    ...
    project.update!(description_multiloc: TextImageService.new.swap_data_images_multiloc(project.description_multiloc, :description_multiloc))
  ...
  def before_update(project, user)
    ...
    project.description_multiloc = TextImageService.new.swap_data_images_multiloc(project.description_multiloc, :description_multiloc)
