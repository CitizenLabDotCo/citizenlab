...
module Surveys
  class ResultsWithDateGenerator < ResultsGenerator
    def initialize(phase, structure_by_category: false, year: nil, quarter: nil, options_sort_order: 'count', exclude_admins_and_moderators: false)
      super(phase, structure_by_category: structure_by_category, options_sort_order: options_sort_order, exclude_admins_and_moderators: exclude_admins_and_moderators)
      @year = year&.to_i
    ...
    def add_averages(results)
      ...
      averages = AverageGenerator.new(phase, exclude_admins_and_moderators: @exclude_admins_and_moderators).field_averages_by_quarter
