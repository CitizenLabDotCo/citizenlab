...
class ParticipantsService
  ...
  def projects_participants(projects, options = {})
    ...
    if actions.include? :polling
      poll_responses = Polls::Response.where(participation_context: Phase.where(project: projects))
    ...
    if actions.include? :volunteering
      ...
      volunteering_users = volunteering_users.where(volunteering_causes: { participation_context: Phase.where(project: projects) })
