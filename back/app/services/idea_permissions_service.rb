  ...
  def action_descriptor(idea, user)
...

    {
      commenting_idea: {
        ...
        future_enabled: commenting_disabled_reason && future_commenting_idea_enabled_phase(idea.project, user)&.start_at
      },
      reacting_idea: {
        ...
        up: {
          enabled: !liking_disabled_reason,
          disabled_reason: liking_disabled_reason,
          future_enabled: liking_disabled_reason && future_liking_idea_enabled_phase(idea.project, user)&.start_at
        },
        down: {
          enabled: !disliking_disabled_reason,
          disabled_reason: disliking_disabled_reason,
          future_enabled: disliking_disabled_reason && future_disliking_idea_enabled_phase(idea.project, user)&.start_at
        }
      },
      comment_reacting_idea: {
        enabled: !comment_reacting_disabled_reason,
        disabled_reason: comment_reacting_disabled_reason,
        future_enabled: comment_reacting_disabled_reason && future_comment_reacting_idea_enabled_phase(idea.project, user)&.start_at
      },
      voting: {
        enabled: !voting_disabled_reason,
        disabled_reason: voting_disabled_reason,
        future_enabled: voting_disabled_reason && future_voting_enabled_phase(idea.project, user)&.start_at
      }
    }
  end
end
