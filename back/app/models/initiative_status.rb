...
class InitiativeStatus < ApplicationRecord
  CODES = %w[review_pending requires_changes proposed expired threshold_reached answered ineligible custom].freeze

  REVIEW_CODES = %w[review_pending requires_changes].freeze
