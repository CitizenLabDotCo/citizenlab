...
#  index_events_attendances_on_attendee_id_and_event_id  (attendee_id,event_id) UNIQUE WHERE (deleted_at IS NULL)
#  index_events_attendances_on_created_at                (created_at)
#  index_events_attendances_on_deleted_at                (deleted_at)
