...
class CustomField < ApplicationRecord
  ...
  has_many :source_logics, -> { ordered_on_source }, foreign_key: :source_field_id, class_name: 'CustomFormLogic', dependent: :destroy, inverse_of: :source_field
  has_many :target_logics, -> { ordered_on_target }, foreign_key: :target_field_id, class_name: 'CustomFormLogic', dependent: :destroy, inverse_of: :target_field
