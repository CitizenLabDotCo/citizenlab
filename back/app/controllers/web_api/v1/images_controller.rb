...
class WebApi::V1::ImagesController < ApplicationController
  ...
  def index
    ...
    render json: WebApi::V1::ImageSerializer.new(@images, params: jsonapi_serializer_params).serializable_hash.to_json
  end

  def show
    render json: WebApi::V1::ImageSerializer.new(@image, params: jsonapi_serializer_params).serializable_hash.to_json
  end
