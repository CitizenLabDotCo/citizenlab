  ...
  def upsert
    ...
    if basket.new_record?
      ...
      begin
        ...
        # A concurrent request created the basket between find_or_initialize_by and save.
        # Reload the winner — its SideFxBasketService.after_create already fired in that request.
