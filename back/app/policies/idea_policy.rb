...
class IdeaPolicy < ApplicationPolicy
  ...
  def create?
    ...
    reason = Permissions::PermissionsService.new.denied_reason_for_project(record.project, user, 'posting_idea')
  ...
  def update?
    ...
    pcs_posting_reason = Permissions::PermissionsService.new.denied_reason_for_project(record.project, user, 'posting_idea')
