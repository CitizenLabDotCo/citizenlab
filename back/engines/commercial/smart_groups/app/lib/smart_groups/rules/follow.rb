...
module SmartGroups::Rules
  class Follow
    ...
    PREDICATE_VALUES = %w[something nothing is_one_of_projects is_not_project is_one_of_folders is_not_folder is_one_of_ideas is_not_idea is_one_of_topics is_not_topic is_one_of_areas is_not_area]
    MULTIVALUE_PREDICATES = %w[is_one_of_projects is_one_of_folders is_one_of_ideas is_one_of_topics is_one_of_areas]
    ...
    def filter(users_scope)
      ...
      when 'is_one_of_projects', 'is_one_of_folders', 'is_one_of_ideas', 'is_one_of_topics', 'is_one_of_areas'
        followers = Follower.where(followable_id: value)
        users_scope.from_follows(followers)
      when 'is_not_project', 'is_not_folder', 'is_not_idea', '', 'is_not_topic', 'is_not_area'
    ...
    def followable_type
      ...
      when 'is_one_of_ideas', 'is_not_idea'
        Idea
