  ...
  describe 'filter' do
    context 'on a select field' do
      ...
      let!(:users) do
        ...
        users[0].custom_field_answers.build(key: custom_field.key, value: options[0].key, custom_field: custom_field)
        users[1].custom_field_answers.build(key: custom_field.key, value: options[0].key, custom_field: custom_field)
        users[2].custom_field_answers.build(key: custom_field.key, value: options[1].key, custom_field: custom_field)
        users[3].custom_field_answers.build(key: custom_field.key, value: options[2].key, custom_field: custom_field)
    ...
    context 'on a multiselect field' do
      ...
      let!(:users) do
        users = build_list(:user, 5)
        users[0].custom_field_answers.build(key: custom_field.key, value: [options[0].key, options[1].key], custom_field: custom_field)
        users[1].custom_field_answers.build(key: custom_field.key, value: [], custom_field: custom_field)
        users[2].custom_field_answers.build(key: custom_field.key, value: [options[1].key], custom_field: custom_field)
        users[3].custom_field_answers.build(key: custom_field.key, value: [options[2].key], custom_field: custom_field)
        # users[4] has no answer
        users.each(&:save!)
