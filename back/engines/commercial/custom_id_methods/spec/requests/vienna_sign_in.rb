...
# See the instructions in back/engines/commercial/custom_id_methods/README.md.
...
def apply_skip_saml_validation_monkey_patch
  ...
  monkey_patch_file_path = 'back/engines/commercial/custom_id_methods/app/lib/custom_id_methods/vienna_saml/citizen_saml_omniauth.rb'
