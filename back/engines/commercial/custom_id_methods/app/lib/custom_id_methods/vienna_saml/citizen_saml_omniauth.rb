...
module CustomIdMethods::ViennaSaml
  ...
  class CitizenSamlOmniauth < IdMethods::Base
    ...
    ENVIRONMENTS = {
      test: {
        ...
        metadata_xml_file: File.join(CustomIdMethods::Engine.root, 'config', 'saml', 'vienna_saml', 'citizen', 'idp_metadata_test.xml')
      },
      production: {
        issuer: 'CitizenLabWien',
        metadata_xml_file: File.join(CustomIdMethods::Engine.root, 'config', 'saml', 'vienna_saml', 'citizen', 'idp_metadata_production.xml')
      }
    }.freeze
