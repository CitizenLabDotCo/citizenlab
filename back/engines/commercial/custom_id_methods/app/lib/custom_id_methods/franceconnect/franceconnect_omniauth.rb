...
module CustomIdMethods::Franceconnect
  class FranceconnectOmniauth < IdMethods::Base
    ...
    #    that calls CustomIdMethods::Franceconnect::FranceconnectOmniauth#omniauth_setup and redirects browser to FranceConnect.
    #    Redirect data contains CustomIdMethods::Franceconnect::FranceconnectOmniauth#redirect_uri (points to OmniauthCallbackController)
    ...
    def can_merge?(user, user_attrs, sso_verification_param_value)
      ...
      matcher = CustomIdMethods::Franceconnect::AttributesMatcher
