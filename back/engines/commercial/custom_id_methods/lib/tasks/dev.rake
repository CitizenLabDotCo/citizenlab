...
def setup_verified_actions_test_data
  ...
  permission.update!(permitted_by: 'verified', global_custom_fields: false, custom_fields_behavior: 'disabled')
  ...
  permission.update!(permitted_by: 'verified', global_custom_fields: false, custom_fields_behavior: 'custom')
  ...
  permission.update!(global_custom_fields: false, custom_fields_behavior: 'custom')
