...
#
# The task will:
#   1. Find the specified phase and validate it's a native survey
#   2. Generate the specified number of responses
#   3. For each response, create random answers for each custom field based on input type
#
# Notes:
...
#   - Skips 'page' input types as they don't store values
