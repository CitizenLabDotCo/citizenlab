  ...
  namespace :web_api do
    namespace :v1 do
      ...
      resources :projects do
        post 'import_ideas/bulk_create_xlsx', on: :member, to: 'import_ideas#bulk_create_xlsx'
        post 'import_ideas/bulk_create_pdf', on: :member, to: 'import_ideas#bulk_create_pdf'
