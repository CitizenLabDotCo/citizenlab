...
module BulkImportIdeas::Legacy
  class IdeaPdfFormExporter < BulkImportIdeas::Exporters::BaseFormExporter
    ...
    def render_field(pdf, custom_field)
      ...
      pdf.group do |pdf_group|
        ...
        if custom_field.input_strategy.supports_linear_scale_labels? && custom_field.description_multiloc[@locale].blank?
