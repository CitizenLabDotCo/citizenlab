...
describe Analysis::InputsFinder do
  ...
  describe 'search' do
    it 'filters correctly' do
      ...
      idea2 = create(:idea, project: analysis.source_project, title_multiloc: { en: 'some candy in a haystack' })
  ...
  describe 'published_at' do
    it 'filters correctly' do
      idea1 = create(:idea, project: analysis.source_project, published_at: '2019-01-01')
      ...
      idea4 = create(:idea, project: analysis.source_project, published_at: '2022-01-01')
  ...
  describe 'reactions' do
    it 'filters correctly' do
      idea1 = create(:idea, project: analysis.source_project, likes_count: 0, dislikes_count: 1)
      idea2 = create(:idea, project: analysis.source_project, likes_count: 10, dislikes_count: 2)
      idea3 = create(:idea, project: analysis.source_project, likes_count: 20, dislikes_count: 3)
      idea4 = create(:idea, project: analysis.source_project, likes_count: 30, dislikes_count: 4)
  ...
  describe 'comments' do
    it 'filters correctly' do
      idea1 = create(:idea, project: analysis.source_project, comments_count: 1)
      idea2 = create(:idea, project: analysis.source_project, comments_count: 2)
  ...
  describe 'votes' do
    it 'filters correctly' do
      ...
      idea3 = create(:idea, project: analysis.source_project, votes_count: 3)
      idea4 = create(:idea, project: analysis.source_project, votes_count: 4)
  ...
  describe 'author_custom_<uuid>_from and author_custom_<uuid>_to' do
    it 'filters correctly on custom_field with input_type number' do
      ...
      author4 = create(:user, custom_field_values: { cf.key => nil })
      author5 = create(:user)
      idea1 = create(:idea, project: analysis.source_project, author: author1)
      idea2 = create(:idea, project: analysis.source_project, author: author2)
      idea3 = create(:idea, project: analysis.source_project, author: author3)
      idea4 = create(:idea, project: analysis.source_project, author: author4)
      idea5 = create(:idea, project: analysis.source_project, author: author5)
