...
module Analysis
  ...
  class InputToText
    ...
    def input_field_value(input, custom_field)
      ...
      # We currently piggyback on the Export::XlsxExport::ValueVisitor, which transforms
      ...
      vv = Export::XlsxExport::ValueVisitor.new(input, custom_field.options.index_by(&:key), app_configuration: @app_configuration)
