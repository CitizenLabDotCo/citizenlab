...
describe WebApi::V1::IdeaSerializer do
  context 'with custom_field_values' do
    describe '#serializable_hash' do
      ...
      let_it_be(:form, reload: true) { create(:custom_form, participation_context: project) }

      let_it_be(:visible_public_field, reload: true) { create(:custom_field, :for_custom_form, resource: form, enabled: true, input_type: 'number', code: 'proposed_budget') }
      let_it_be(:visible_admin_field, reload: true) { create(:custom_field, :for_custom_form, resource: form, enabled: true, input_type: 'number') }
      let_it_be(:disabled_field, reload: true) { create(:custom_field, :for_custom_form, resource: form, enabled: false, input_type: 'number') }
      ...
      let_it_be(:idea_author, reload: true) { create(:user) }
