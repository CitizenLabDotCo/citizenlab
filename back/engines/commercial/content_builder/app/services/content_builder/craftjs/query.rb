...
module ContentBuilder
  module Craftjs
    ...
    module Query
      ...
      # linkedNodes slots left to right — yielding (id, node, depth, slot); slot is the
      # parent's linkedNodes slot name, nil for ordinary children. Starts at ROOT, or at
      # `from` to walk one subtree, with depth relative to it.
      #
