...
resource "Moderators" do
  ...
  get "web_api/v1/projects/:project_id/moderators" do
    ...
    context "when moderator" do
      ...
      let!(:same_project_moderators) { create_list(:project_moderator, 5, project: @project) }
      let!(:other_project) { create(:project) }
      let!(:other_project_moderators) { create_list(:project_moderator, 2, project: other_project) }
    ...
    context "when admin" do
      ...
      let(:project_id) { @project.id }
      let!(:same_project_moderators) { create_list(:project_moderator, 2, project: @project) }
  ...
  get "web_api/v1/projects/:project_id/moderators/:user_id" do
    ...
    context "when moderator" do
      ...
      let(:other_moderators) { create_list(:project_moderator, 2, project: @project) }
      let(:project_id) { @project.id }
