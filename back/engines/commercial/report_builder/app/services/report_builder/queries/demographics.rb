  ...
  class Queries::Demographics < ReportBuilder::Queries::Base
    def run_query(
      ...
      **_other_props
      ...
      users = find_users(start_at, end_at, project_id, group_id, exclude_roles)
    ...
    def find_users(start_at, end_at, project_id, group_id, exclude_roles)
      ...
      users = users.normal_user if exclude_admins_and_moderators?(exclude_roles)
