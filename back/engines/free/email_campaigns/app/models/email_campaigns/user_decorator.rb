...
module EmailCampaigns::UserDecorator
  ...
  included do
    ...
    has_many :email_campaigns_examples, class_name: 'EmailCampaigns::Example', foreign_key: :recipient_id
    before_destroy { email_campaigns_examples.each(&:destroy_fully!) }
