...
module EmailCampaigns
  class Campaigns::InternalCommentOnIdeaYouCommentedInternallyOn < Campaign
    include Consentable
    ...
    def activity_triggers
      { 'Notifications::InternalComments::InternalCommentOnIdeaYouCommentedInternallyOn' => { 'created' => true } }
    end
    ...
    def mailer_class
      InternalCommentOnIdeaYouCommentedInternallyOnMailer
    end
