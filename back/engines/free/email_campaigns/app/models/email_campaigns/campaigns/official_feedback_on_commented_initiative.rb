...
module EmailCampaigns
  class Campaigns::OfficialFeedbackOnCommentedInitiative < Campaign
    include Consentable
    ...
    def mailer_class
      OfficialFeedbackOnCommentedInitiativeMailer
    end
    ...
    def self.recipient_segment_label
      # I18n.t('email_campaigns.admin_labels.recipient_segment.users_engaged_with_the_proposal')
    end
    ...
    def self.trigger_label
      # I18n.t('email_campaigns.admin_labels.trigger.proposal_status_is_changed')
    end
