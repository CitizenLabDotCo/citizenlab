...
module EmailCampaigns
  class Campaigns::OfficialFeedbackOnCommentedIdea < Campaign
    include Consentable
    ...
    def mailer_class
      OfficialFeedbackOnCommentedIdeaMailer
    end
    ...
    def self.trigger_label
      # @multiloc_service ||= MultilocService.new
      @multiloc_service.i18n_to_multiloc('email_campaigns.admin_labels.trigger.idea_status_is_changed')
    end
