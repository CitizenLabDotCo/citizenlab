...
module EmailCampaigns
  class Campaigns::InternalCommentOnIdeaAssignedToYou < Campaign
    include Consentable
    ...
    def activity_triggers
      { 'Notifications::InternalComments::InternalCommentOnIdeaAssignedToYou' => { 'created' => true } }
    end
    ...
    def self.trigger_multiloc_key
      'email_campaigns.admin_labels.trigger.internal_comment_is_posted_on_idea_assigned_to_user'
    end

    def mailer_class
      InternalCommentOnIdeaAssignedToYouMailer
    end
