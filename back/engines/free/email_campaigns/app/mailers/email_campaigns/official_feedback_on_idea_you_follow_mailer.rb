...
module EmailCampaigns
  class OfficialFeedbackOnIdeaYouFollowMailer < ApplicationMailer
    ...
    def subject
      format_message('subject', values: { organizationName: organization_name, input_title: localize_for_recipient(event.idea_title_multiloc) })
    end

    def header_title
      format_message('header_title', values: { organizationName: organization_name, input_title: localize_for_recipient(event.idea_title_multiloc) })
    end
