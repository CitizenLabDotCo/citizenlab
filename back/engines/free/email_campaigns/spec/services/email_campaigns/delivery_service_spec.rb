  ...
  describe 'campaign_types' do
    ...
    it 'returns campaign_types that all have at least 1 campaign_type_description and admin_campaign_type_description translation defined' do
      ...
      service.campaign_types.each do |campaign_type|
        ...
        campaign_name = campaign_type.constantize.campaign_name.sub 'reacted', 'voted'
        expect { multiloc_service.i18n_to_multiloc("email_campaigns.campaign_type_description.#{campaign_name}") }
          .not_to raise_error
        expect { multiloc_service.i18n_to_multiloc("email_campaigns.admin_campaign_type_description.#{campaign_name}") }
          .not_to raise_error
      end
    end
