...
RSpec.describe EmailCampaigns::Campaigns::CommentOnIdeaYouFollow do
  ...
  describe 'send_on_activity' do
    let_it_be(:global_campaign, reload: true) { create(:comment_on_idea_you_follow_campaign) }
    ...
    context 'for a context campaign' do
      ...
      context 'for a future phase' do
        let(:phase) { create(:ideation_phase, start_at: 2.days.from_now, end_at: 6.days.from_now) }
