...
RSpec.describe EmailCampaigns::Campaigns::NativeSurveyNotSubmitted do
  ...
  describe '#generate_commands' do
    ...
    let_it_be(:input, reload: true) { create(:native_survey_response, author: create(:user)) }
  ...
  describe 'send_on_activity' do
    ...
    let_it_be(:global_campaign, reload: true) { create(:native_survey_not_submitted_campaign) }
