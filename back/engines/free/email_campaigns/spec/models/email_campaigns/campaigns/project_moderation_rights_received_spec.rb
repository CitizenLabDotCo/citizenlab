...
RSpec.describe EmailCampaigns::Campaigns::ProjectModerationRightsReceived do
  ...
  describe '#generate_commands' do
    let_it_be(:campaign, reload: true) { create(:project_moderation_rights_received_campaign) }
    let_it_be(:notification, reload: true) { create(:project_moderation_rights_received) }
