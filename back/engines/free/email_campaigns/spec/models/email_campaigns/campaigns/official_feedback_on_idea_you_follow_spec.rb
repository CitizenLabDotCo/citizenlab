...
RSpec.describe EmailCampaigns::Campaigns::OfficialFeedbackOnIdeaYouFollow do
  ...
  describe '#generate_commands' do
    let_it_be(:campaign, reload: true) { create(:official_feedback_on_idea_you_follow_campaign) }
    let_it_be(:notification, reload: true) { create(:official_feedback_on_idea_you_follow) }
