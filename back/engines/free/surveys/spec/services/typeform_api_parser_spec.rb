...
describe Surveys::TypeformApiParser do
  ...
  let(:form_response_return_value) {{
    ...
    [{"id"=>"IspfFyBxDu9D",
      ...
      "type"=>"short_text"},
     {"id"=>"YmQnQ7hWb35U",
      "title"=>"Alright, these questions are about the *course* *design.* ",
      "ref"=>"a20605b157ac355e",
      "properties"=>
       {"button_text"=>"Continue",
        "show_button"=>false,
        "fields"=>
        [{"id"=>"ovPVMRTP5lIu",
          "title"=>"In your opinion, how clear were the *course objectives*?",
          "ref"=>"506d8225bc313735",
          "properties"=>
           {"start_at_one"=>true,
            "steps"=>5,
          ...
          "type"=>"opinion_scale"},
         {"id"=>"swUKkFYpGsmy",
          "title"=>"And did the *structure and sequence of the lectures* make sense?",
          "ref"=>"c9327ddbb4cf0f4f",
          "properties"=>
           {"start_at_one"=>true,
            "steps"=>5,
          ...
          "type"=>"opinion_scale"},
         {"id"=>"yS0DggYfRZM7",
          "title"=>"And the *level* of the course wasxE2x80xA6",
          "ref"=>"fa0f140f575b27ba",
          "properties"=>
           {"start_at_one"=>true,
            "steps"=>5,
