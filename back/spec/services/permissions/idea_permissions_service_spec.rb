...
describe Permissions::IdeaPermissionsService do
  ...
  describe 'action_descriptors' do
    it 'does not run more than 8 queries for 5 ideas in a project with default user permissions' do
      user = create(:user)
      ...
      end.not_to exceed_query_limit(8) # Down from an original 486
    end
  end
end
