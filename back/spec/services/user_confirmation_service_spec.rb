  ...
  describe '#validate_and_confirm_unauthenticated!' do
    ...
    context 'when the user is nil' do
      it 'returns a user blank error' do
        result = service.validate_and_confirm_unauthenticated!(nil, '1234')
    ...
    context 'when the code is nil' do
      it 'returns a code blank error' do
        result = service.validate_and_confirm_unauthenticated!(user, nil)
    ...
    context 'when the code is incorrect' do
      it 'returns a code invalid error' do
        result = service.validate_and_confirm_unauthenticated!(user, 'failcode')
