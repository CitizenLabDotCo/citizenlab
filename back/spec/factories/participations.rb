FactoryBot.define do
  ...
  factory :participation, class: Hash do
    ...
    initialize_with do
      ...
      cfvs = user_answers.presence || participation_user.custom_field_answers.to_h { [it.key, it.value] }
  ...
  factory :basket_participation, parent: :participation do
    initialize_with do
      ...
      cfvs = user_answers.presence || basket.user.custom_field_answers.to_h { [it.key, it.value] }
  ...
  factory :posting_idea_participation, parent: :participation do
    initialize_with do
      ...
      cfvs = user_answers.presence || idea.author.custom_field_answers.to_h { [it.key, it.value] }
  ...
  factory :commenting_idea_participation, parent: :participation do
    initialize_with do
      ...
      cfvs = user_answers.presence || comment.author.custom_field_answers.to_h { [it.key, it.value] }
  ...
  factory :reacting_idea_participation, parent: :participation do
    initialize_with do
      ...
      cfvs = user_answers.presence || reaction.user.custom_field_answers.to_h { [it.key, it.value] }
  ...
  factory :taking_poll_participation, parent: :participation do
    initialize_with do
      ...
      cfvs = user_answers.presence || response.user.custom_field_answers.to_h { [it.key, it.value] }
  ...
  factory :volunteering_participation, parent: :participation do
    initialize_with do
      ...
      cfvs = user_answers.presence || volunteer.user.custom_field_answers.to_h { [it.key, it.value] }
