...
RSpec.configure do |config|
  ...
  config.before(:suite) do
    ...
    require './engines/free/email_campaigns/spec/factories/sms_campaigns'
    ...
    require './engines/free/email_campaigns/spec/factories/sms_consents'
    ...
    begin
      Apartment::Tenant.drop('example_org')
