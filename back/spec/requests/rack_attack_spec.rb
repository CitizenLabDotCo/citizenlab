...
describe 'Rack::Attack' do
  ...
  describe 'phone endpoints' do
    ...
    it 'limits unauthenticated phone code requests from same IP to 10 in 5 minutes' do
      params = '{ "request_code": { "phone": "+14155552671" } }'

      freeze_time do
        10.times { post('/web_api/v1/user/request_code_phone', params: params, headers: headers) }
        expect(status).to eq(401) # Unauthorized
