...
describe 'Rack::Attack' do
  ...
  describe 'confirmation code endpoints' do
    endpoints = [
      ...
      { path: '/web_api/v1/user/request_code_merge_account', root: 'request_code', identifier: 'merge_target_email' },
      ...
      { path: '/web_api/v1/user/confirm_code_merge_account', root: 'confirmation', identifier: nil },
