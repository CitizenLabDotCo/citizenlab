...
describe IdeasFinder do
  ...
  def initialize_inputs_for_scope_filtering
    ...
    voting_phase = create(:voting_phase, project: timeline_project, voting_method: 'budgeting', voting_max_total: 1000, start_at: Time.zone.today, end_at: (Time.zone.today + 1.day))
