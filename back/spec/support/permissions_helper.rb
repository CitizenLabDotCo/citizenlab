...
module PermissionsHelper
  # Inheritable permissions are only persisted once the action is overridden;
  # until then it inherits the global 'visiting' permission. Use this in specs
  # that need a scope to own its permissions.
