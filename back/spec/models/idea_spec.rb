...
RSpec.describe Idea do
  ...
  describe 'body sanitizer' do
    ...
    it "allows embedded youtube video's in the body" do
      ...
      expect(idea.body_multiloc).to eq({ 'en' => '<iframe class="ql-video" frameborder="0" allowfullscreen="true" src="https://www.youtube.com/embed/Bu2wNKlVRzE?showinfo=0" height="242.5" width="485" data-blot-formatter-unclickable-bound="true" referrerpolicy=\"strict-origin-when-cross-origin\"></iframe>' })
    end
  end
