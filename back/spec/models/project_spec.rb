...
RSpec.describe Project do
  ...
  describe '#phases_span' do
    ...
    it 'returns nil when the project has no phases' do
      expect(project.phases_span).to be_nil
    end
    ...
    it 'spans from the earliest start to the latest end across placement types' do
      ...
      expect(project.phases_span).to eq [timeline_phase.start_date, standalone_phase.end_date]
    end
    ...
    it 'leaves the end open when any phase is open-ended' do
      ...
      expect(project.phases_span).to eq [timeline_phase.start_date, nil]
    end
  end
  ...
  describe '#active_span' do
    ...
    it 'returns nil when no phase is active' do
      ...
      expect(project.active_span).to be_nil
    end
    ...
    it 'spans from the earliest start to the latest end of the active phases' do
      ...
      expect(project.active_span).to eq [timeline_phase.start_date, standalone_phase.end_date]
    end
    ...
    it 'leaves the end open when an active phase is open-ended' do
      ...
      expect(project.active_span).to eq [timeline_phase.start_date, nil]
    end
  end
end
