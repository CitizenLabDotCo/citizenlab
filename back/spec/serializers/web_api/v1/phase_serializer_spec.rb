...
describe WebApi::V1::PhaseSerializer do
  ...
  context 'for a past voting phase' do
    let(:phase) { create(:single_voting_phase, start_at: Time.zone.now.beginning_of_day - 5.days, end_at: Time.zone.now.beginning_of_day - 1.day, baskets_count: 4, votes_count: 7) }
  ...
  context 'for an active voting phase' do
    let(:phase) { create(:single_voting_phase, start_at: Time.zone.now.beginning_of_day - 5.days, end_at: Time.zone.now.beginning_of_day + 6.days, baskets_count: 4, votes_count: 7) }
  ...
  context 'for a future voting phase' do
    let(:phase) { create(:single_voting_phase, start_at: Time.zone.now.beginning_of_day + 2.days, end_at: Time.zone.now.beginning_of_day + 6.days, baskets_count: 4, votes_count: 7) }
