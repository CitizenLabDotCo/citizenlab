...
resource 'Reactions' do
  ...
  post 'web_api/v1/initiatives/:initiative_id/reactions' do
    ...
    disabled_reasons = Permissions::InitiativePermissionsService::REACTING_DENIED_REASONS.values + Permissions::InitiativePermissionsService::USER_DENIED_REASONS.values
