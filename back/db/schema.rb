...
ActiveRecord::Schema[7.0].define(version: 20_230_814_115_846) do
  ...
  create_table 'activities', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[item_type item_id], name: 'index_activities_on_item'
  ...
  create_table 'admin_publications', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[publication_type publication_id], name: 'index_admin_publications_on_publication_type_and_publication_id'
  ...
  create_table 'analysis_analyses_custom_fields', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[analysis_id custom_field_id], name: 'index_analysis_analyses_custom_fields', unique: true
  ...
  create_table 'analysis_taggings', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[tag_id input_id], name: 'index_analysis_taggings_on_tag_id_and_input_id', unique: true
  ...
  create_table 'analysis_tags', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[analysis_id name], name: 'index_analysis_tags_on_analysis_id_and_name', unique: true
  ...
  create_table 'analytics_dimension_locales_fact_visits', id: false, force: :cascade do |t|
    ...
    t.index %w[dimension_locale_id fact_visit_id], name: 'i_analytics_dim_locales_fact_visits_on_locale_and_visit_ids', unique: true
  ...
  create_table 'analytics_dimension_projects_fact_visits', id: false, force: :cascade do |t|
    ...
    t.uuid 'fact_visit_id'
    t.index %w[dimension_project_id fact_visit_id], name: 'i_analytics_dim_projects_fact_visits_on_project_and_visit_ids', unique: true
  ...
  create_table 'analytics_dimension_types', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    t.string 'name'
    t.string 'parent'
    t.index %w[name parent], name: 'index_analytics_dimension_types_on_name_and_parent', unique: true
  end
  ...
  create_table 'areas_ideas', id: :uuid, default: -> { 'uuid_generate_v4()' }, force: :cascade do |t|
    ...
    t.index %w[idea_id area_id], name: 'index_areas_ideas_on_idea_id_and_area_id', unique: true
  ...
  create_table 'areas_initiatives', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[initiative_id area_id], name: 'index_areas_initiatives_on_initiative_id_and_area_id', unique: true
  ...
  create_table 'baskets_ideas', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[basket_id idea_id], name: 'index_baskets_ideas_on_basket_id_and_idea_id', unique: true
  ...
  create_table 'comments', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[post_id post_type], name: 'index_comments_on_post_id_and_post_type'
  ...
  create_table 'content_builder_layouts', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[content_buildable_type content_buildable_id code], name: 'index_content_builder_layouts_content_buidable_type_id_code', unique: true
  end
  ...
  create_table 'custom_field_options', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[custom_field_id key], name: 'index_custom_field_options_on_custom_field_id_and_key', unique: true
  ...
  create_table 'custom_fields', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[resource_type resource_id], name: 'index_custom_fields_on_resource_type_and_resource_id'
  end
  ...
  create_table 'custom_forms', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[participation_context_id participation_context_type], name: 'index_custom_forms_on_participation_context', unique: true
  end
  ...
  create_table 'email_campaigns_campaigns_groups', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[campaign_id group_id], name: 'index_campaigns_groups', unique: true
  ...
  create_table 'email_campaigns_consents', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[campaign_type user_id], name: 'index_email_campaigns_consents_on_campaign_type_and_user_id', unique: true
  ...
  create_table 'email_campaigns_deliveries', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[campaign_id user_id], name: 'index_email_campaigns_deliveries_on_campaign_id_and_user_id'
  ...
  create_table 'email_snippets', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[email snippet locale], name: 'index_email_snippets_on_email_and_snippet_and_locale'
  end
  ...
  create_table 'events_attendances', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[attendee_id event_id], name: 'index_events_attendances_on_attendee_id_and_event_id', unique: true
  ...
  create_table 'flag_inappropriate_content_inappropriate_content_flags', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[flaggable_id flaggable_type], name: 'inappropriate_content_flags_flaggable'
  end
  ...
  create_table 'groups_projects', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[group_id project_id], name: 'index_groups_projects_on_group_id_and_project_id', unique: true
  ...
  create_table 'ideas_phases', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.integer 'baskets_count', default: 0, null: false
    t.integer 'votes_count', default: 0, null: false
    t.index %w[idea_id phase_id], name: 'index_ideas_phases_on_idea_id_and_phase_id', unique: true
  ...
  create_table 'ideas_topics', id: :uuid, default: -> { 'uuid_generate_v4()' }, force: :cascade do |t|
    t.uuid 'idea_id'
    t.uuid 'topic_id'
    t.index %w[idea_id topic_id], name: 'index_ideas_topics_on_idea_id_and_topic_id', unique: true
  ...
  create_table 'initiatives_topics', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    t.uuid 'initiative_id'
    t.uuid 'topic_id'
    t.index %w[initiative_id topic_id], name: 'index_initiatives_topics_on_initiative_id_and_topic_id', unique: true
  ...
  create_table 'insights_categories', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.uuid 'source_id'
    t.index %w[source_type source_id], name: 'index_insights_categories_on_source'
    t.index ['source_type'], name: 'index_insights_categories_on_source_type'
    t.index %w[view_id name], name: 'index_insights_categories_on_view_id_and_name', unique: true
  ...
  create_table 'insights_category_assignments', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[category_id input_id input_type], name: 'index_single_category_assignment', unique: true
    t.index ['category_id'], name: 'index_insights_category_assignments_on_category_id'
    t.index %w[input_type input_id], name: 'index_insights_category_assignments_on_input_type_and_input_id'
  end
  ...
  create_table 'insights_data_sources', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[origin_type origin_id], name: 'index_insights_data_sources_on_origin'
    t.index %w[view_id origin_type origin_id], name: 'index_insights_data_sources_on_view_and_origin', unique: true
  ...
  create_table 'insights_processed_flags', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[input_id input_type view_id], name: 'index_single_processed_flags', unique: true
    t.index %w[input_type input_id], name: 'index_processed_flags_on_input'
  ...
  create_table 'insights_text_networks', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[view_id language], name: 'index_insights_text_networks_on_view_id_and_language', unique: true
  ...
  create_table 'insights_zeroshot_classification_tasks_categories', id: false, force: :cascade do |t|
    t.uuid 'category_id', null: false
    t.uuid 'task_id', null: false
    t.index %w[category_id task_id], name: 'index_insights_zsc_tasks_categories_on_category_id_and_task_id', unique: true
  ...
  create_table 'insights_zeroshot_classification_tasks_inputs', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.string 'input_type', null: false
    t.uuid 'input_id', null: false
    t.index %w[input_id input_type task_id], name: 'index_insights_zsc_tasks_inputs_on_input_and_task_id', unique: true
    t.index %w[input_type input_id], name: 'index_insights_zsc_tasks_inputs_on_input'
  ...
  create_table 'internal_comments', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[post_type post_id], name: 'index_internal_comments_on_post'
  ...
  create_table 'machine_translations_machine_translations', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[translatable_id translatable_type attribute_name locale_to], name: 'machine_translations_lookup', unique: true
    t.index %w[translatable_id translatable_type], name: 'machine_translations_translatable'
  end
  ...
  create_table 'memberships', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[group_id user_id], name: 'index_memberships_on_group_id_and_user_id', unique: true
  ...
  create_table 'moderation_moderation_statuses', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[moderatable_type moderatable_id], name: 'moderation_statuses_moderatable', unique: true
  end
  ...
  create_table 'notifications', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[post_id post_type], name: 'index_notifications_on_post_id_and_post_type'
    t.index %w[post_status_id post_status_type], name: 'index_notifications_on_post_status_id_and_post_status_type'
    t.index ['post_status_id'], name: 'index_notifications_on_post_status_id'
    t.index %w[recipient_id read_at], name: 'index_notifications_on_recipient_id_and_read_at'
  ...
  create_table 'official_feedbacks', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: nil, null: false
    t.string 'post_type'
    t.index %w[post_id post_type], name: 'index_official_feedbacks_on_post'
  ...
  create_table 'onboarding_campaign_dismissals', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[campaign_name user_id], name: 'index_dismissals_on_campaign_name_and_user_id', unique: true
  ...
  create_table 'permissions_custom_fields', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[permission_id custom_field_id], name: 'index_permission_field', unique: true
  ...
  create_table 'pins', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[page_id admin_publication_id], name: 'index_pins_on_page_id_and_admin_publication_id', unique: true
  end
  ...
  create_table 'polls_responses', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[participation_context_id participation_context_type user_id], name: 'index_polls_responses_on_participation_context_and_user_id', unique: true
  ...
  create_table 'projects_allowed_input_topics', id: :uuid, default: -> { 'uuid_generate_v4()' }, force: :cascade do |t|
    ...
    t.index %w[topic_id project_id], name: 'index_projects_allowed_input_topics_on_topic_id_and_project_id', unique: true
  end
  ...
  create_table 'que_jobs', comment: '4', force: :cascade do |t|
    ...
    t.index %w[job_schema_version queue priority run_at id], name: 'que_poll_idx_with_job_schema_version', where: '((finished_at IS NULL) AND (expired_at IS NULL))'
    t.index %w[queue priority run_at id], name: 'que_poll_idx', where: '((finished_at IS NULL) AND (expired_at IS NULL))'
  end
  ...
  create_table 'reactions', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[reactable_type reactable_id user_id], name: 'index_reactions_on_reactable_type_and_reactable_id_and_user_id', unique: true
    t.index %w[reactable_type reactable_id], name: 'index_reactions_on_reactable_type_and_reactable_id'
  ...
  create_table 'spam_reports', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[spam_reportable_type spam_reportable_id], name: 'spam_reportable_index'
  ...
  create_table 'volunteering_volunteers', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[cause_id user_id], name: 'index_volunteering_volunteers_on_cause_id_and_user_id', unique: true
