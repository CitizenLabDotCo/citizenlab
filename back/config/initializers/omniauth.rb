...
# OmniAuth strategies for the built-in SSO methods (Facebook, Google, Azure AD,
# Azure AD B2C) are registered in the custom_id_methods engine, alongside the
# other SSO / verification methods.
