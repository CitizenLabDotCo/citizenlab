...
`,CustomRadio=styled_components_browser_esm.Ay.div`
  ...
  background: #fff;
  border-radius: 50%;
  border: solid 1px ${styleUtils.Tj.grey500};
...
`,Checked=styled_components_browser_esm.Ay.div`
  flex: 0 0 12px;
  width: 12px;
  height: 12px;
...
//# sourceMappingURL=components-Radio-Radio-stories-mdx.b738e247.iframe.bundle.js.map